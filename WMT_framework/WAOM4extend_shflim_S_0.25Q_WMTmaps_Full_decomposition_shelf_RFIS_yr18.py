...
dx = xr.open_dataset('/g/data3/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom4extend_shflim_S_0.25Q/output_yr18/Full_vint_vars_for_WMT_m.s-1.nc')
...
plt.title('I) Salt tendency', fontsize=16)
...
plt.title('J) Salt advection', fontsize=16)
...
plt.title('K) Salt diffusion', fontsize=16)
...
plt.title('L) Surface salt flux', fontsize=16)
...
name_fig="waom4extend_shflim_S_0.25Q_10km-bathy_WMTmaps_salt_budget_annual_yr18_shelf_RFIS_27.3-27.8kgm-3.png"
...
name_fig="waom4extend_shflim_S_0.25Q_WMTmaps_Full_salt_budget+_annual_yr18_shelf_RFIS_27.3-27.8kgm-3.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
for mm in np.arange(0,12):
    ...
    ax1 = fig.add_subplot(221, projection=proj)
    plt.title('Salt tendency, $\sigma_{\Theta}$ = ' + str(np.around(rho_grid[29],decimals=2)) + ':'  + str(np.around(rho_grid[32],decimals=2)), fontsize=14)
    cy=plt.pcolormesh(lon_rho,lat_rho,salt_net_sum_mm, transform=ccrs.PlateCarree(), cmap=plt.cm.coolwarm, vmin=-2e-6, vmax=2e-6)
    ax1.gridlines()
    ax1.set_extent([-85, -30, -84, -74], crs=ccrs.PlateCarree())
    ax1.add_feature(cfeature.LAND, zorder=3, edgecolor='white', facecolor='gray')
    ...
    ax2 = fig.add_subplot(222, projection=proj)
    plt.title('Salt advection, $\sigma_{\Theta}$ = ' + str(np.around(rho_grid[29],decimals=2)) + ':'  + str(np.around(rho_grid[32],decimals=2)), fontsize=14)
    cy=plt.pcolormesh(lon_rho,lat_rho,salt_adv_sum_mm, transform=ccrs.PlateCarree(), cmap=plt.cm.coolwarm, vmin=-2e-6, vmax=2e-6)
    ax2.gridlines()
    ax2.set_extent([-85, -30, -84, -74], crs=ccrs.PlateCarree())
    ax2.add_feature(cfeature.LAND, zorder=3, edgecolor='white', facecolor='gray')
    ...
    ax3 = fig.add_subplot(223, projection=proj)
    plt.title('Salt diffusion, $\sigma_{\Theta}$ = ' + str(np.around(rho_grid[29],decimals=2)) + ':'  + str(np.around(rho_grid[32],decimals=2)), fontsize=14)
    cy=plt.pcolormesh(lon_rho,lat_rho,salt_diff_sum_mm-salt_sfc_sum_mm, transform=ccrs.PlateCarree(), cmap=plt.cm.coolwarm, vmin=-2e-6, vmax=2e-6)
    ax3.gridlines()
    ax3.set_extent([-85, -30, -84, -74], crs=ccrs.PlateCarree())
    ax3.add_feature(cfeature.LAND, zorder=3, edgecolor='white', facecolor='gray')
    ...
    plt.title('Salt sfc flux, $\sigma_{\Theta}$ = ' + str(np.around(rho_grid[29],decimals=2)) + ':'  + str(np.around(rho_grid[32],decimals=2)), fontsize=14)
    cy=plt.pcolormesh(lon_rho,lat_rho,salt_sfc_sum_mm, transform=ccrs.PlateCarree(), cmap=plt.cm.coolwarm, vmin=-2e-6, vmax=2e-6)
    ax4.gridlines()
    ax4.set_extent([-85, -30, -84, -74], crs=ccrs.PlateCarree())
    ax4.add_feature(cfeature.LAND, zorder=3, edgecolor='white', facecolor='gray')
    ...
    name_fig="waom4extend_shflim_S_0.25Q_10km-bathy_WMTmaps_salt_budget_annual_yr18_shelf_mm=" + str(mm) + "_RFIS_27.3-27.6kgm-3.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
