...
ax2.gridlines()
lonlat_labels(ax2)
ax2.set_extent([-150, -55, -76, -70], crs=ccrs.PlateCarree())
...
ax3.gridlines()
lonlat_labels(ax3)
ax3.set_extent([-150, -55, -76, -70], crs=ccrs.PlateCarree())
ax3.add_feature(cfeature.LAND, zorder=1, edgecolor='black', facecolor='white')
plt.clim(-2e-6,2e-6)

#ax4 = fig.add_subplot(134, projection=proj)
...
name_fig="waom4extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr10_shelf_WAnt.png"
...
#    plt.clim(-2e-6,2e-6)
    ...
    name_fig="waom4extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr10_shelf_mm=" + str(mm) + "_WAnt.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
