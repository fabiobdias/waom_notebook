...
dx = xr.open_dataset('/g/data3/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom4extend_shflim_S_0.25Q/output_yr10_notides_diag/Full_vint_vars_for_WMT_m.s-1.nc')
...
Fs_rate_delta_adv_vint_shelf_noice_mm = wmt(salt_adv_full_vint*mask_shelf*mask_zice, dx, dy,'budget')
...
name_fig="waom4extend_shflim_S_0.25Q_notides_WMT_Full_sfc_fluxes_annual_shelf_noice_comparison.png"
...
name_fig="waom4extend_shflim_S_0.25Q_notides_WMT_Full_heat-salt_vint_annual_shelf_noice.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
# call cartopy projection
    ...
    name_fig="waom4extend_shflim_S_0.25Q_notides_WMTmaps_Full_annual_yr10_l" + str(irho)  + "_shelf_noice.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
...
name_fig="waom4extend_shflim_S_0.25Q_notides_WMTmaps_Full_annual_yr10_shelf_noice.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
np.savez(npy_path + 'WAOM4extend_notides_Full_WMT_shelf_noice_sfc_total',rho_grid = rho_grid, F_sig_sfc_shelf_noice = F_sig_sfc_shelf_noice)
np.savez(npy_path + 'WAOM4extend_notides_Full_WMT_shelf_noice_sfc_salt',rho_grid = rho_grid, Fs_sig_sfc_shelf_noice = Fs_sig_sfc_shelf_noice)
np.savez(npy_path + 'WAOM4extend_notides_Full_WMT_shelf_noice_sfc_heat',rho_grid = rho_grid, Fh_sig_sfc_shelf_noice = Fh_sig_sfc_shelf_noice)

np.savez(npy_path + 'WAOM4extend_notides_Full_WMT_shelf_noice_vint_salt_net',rho_grid = rho_grid, Fs_sig_net_vint_shelf_noice = Fs_sig_net_vint_shelf_noice)
np.savez(npy_path + 'WAOM4extend_notides_Full_WMT_shelf_noice_vint_salt_diff',rho_grid = rho_grid, Fs_sig_diff_vint_shelf_noice = Fs_sig_diff_vint_shelf_noice)
np.savez(npy_path + 'WAOM4extend_notides_Full_WMT_shelf_noice_vint_salt_adv',rho_grid = rho_grid, Fs_sig_adv_vint_shelf_noice = Fs_sig_adv_vint_shelf_noice)

np.savez(npy_path + 'WAOM4extend_notides_Full_WMT_shelf_noice_vint_heat_net', rho_grid = rho_grid, Fh_sig_net_vint_shelf_noice = Fh_sig_net_vint_shelf_noice)
np.savez(npy_path + 'WAOM4extend_notides_Full_WMT_shelf_noice_vint_heat_diff', rho_grid = rho_grid, Fh_sig_diff_vint_shelf_noice = Fh_sig_diff_vint_shelf_noice)
np.savez(npy_path + 'WAOM4extend_notides_Full_WMT_shelf_noice_vint_heat_adv', rho_grid = rho_grid, Fh_sig_adv_vint_shelf_noice = Fh_sig_adv_vint_shelf_noice)
