...
dx = xr.open_dataset('/g/data3/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom2extend_shflim_S_0.25Q/output_yr5_diag/SemiFull_vint_vars_for_WMT_m.s-1.nc')
...
#    salt_net_tmp = np.nanmean(Fs_rate_delta_net_vint_shelf_mm[:,irho,:], axis=0)*Dt/(dx*dy)
    ...
    # horiz adv
    salt_hadv_tmp = np.empty((12,2800,3150))
    for mm in np.arange(0,12):
        salt_hadv_tmp[mm,:] = Fs_rate_delta_hadv_vint_shelf_mm[mm,irho,:]*Dt/(dx*dy)
    ...
    # vert adv
    salt_vadv_tmp = np.empty((12,2800,3150))
    for mm in np.arange(0,12):
        salt_vadv_tmp[mm,:] = Fs_rate_delta_vadv_vint_shelf_mm[mm,irho,:]*Dt/(dx*dy)
...
plt.title('G) Salt tendency + advection', fontsize=16)
...
ax1.set_ylabel('WAOM2',fontsize=16)
plt.ylabel('WAOM2',fontsize=16)

ax3 = fig.add_subplot(3,3,8, projection=proj)
plt.title('H) Salt diffusion', fontsize=16)
...
ax4 = fig.add_subplot(3,3,9, projection=proj)
...
name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_SemiFull_salt_budget_annual_yr10_shelf_RFIS_27.3-27.8kgm-3.png"
...
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],ice_draft[xlimit,ylimit],levels=[-.1],linestyles='dashed', transform=ccrs.PlateCarree(), cmap=plt.cm.binary)
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],h[xlimit,ylimit],levels=(200,400,600,800,1000), transform=ccrs.PlateCarree(), colors='grey')
ax2.set_ylabel('WAOM2',fontsize=16)
plt.ylabel('WAOM2',fontsize=16)
...
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],ice_draft[xlimit,ylimit],levels=[-.1],linestyles='dashed', transform=ccrs.PlateCarree(), cmap=plt.cm.binary)
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],h[xlimit,ylimit],levels=(200,400,600,800,1000), transform=ccrs.PlateCarree(), colors='grey')
ax5.set_ylabel('WAOM2',fontsize=16)
plt.ylabel('WAOM2',fontsize=16)

ax6 = fig.add_subplot(3,4,6, projection=proj)
plt.title('Salt horiz. advection', fontsize=16)
cy=plt.pcolormesh(lon_rho,lat_rho,np.nanmean(salt_hadv_sum, axis=0), transform=ccrs.PlateCarree(), cmap=plt.cm.coolwarm, vmin=-2e-5, vmax=2e-5)
ax6.gridlines()
...
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],ice_draft[xlimit,ylimit],levels=[-.1],linestyles='dashed', transform=ccrs.PlateCarree(), cmap=plt.cm.binary)
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],h[xlimit,ylimit],levels=(200,400,600,800,1000), transform=ccrs.PlateCarree(), colors='grey')
ax6.set_ylabel('WAOM2',fontsize=16)
plt.ylabel('WAOM2',fontsize=16)
...
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],ice_draft[xlimit,ylimit],levels=[-.1],linestyles='dashed', transform=ccrs.PlateCarree(), cmap=plt.cm.binary)
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],h[xlimit,ylimit],levels=(200,400,600,800,1000), transform=ccrs.PlateCarree(), colors='grey')
ax7.set_ylabel('WAOM2',fontsize=16)
plt.ylabel('WAOM2',fontsize=16)

ax9 = fig.add_subplot(3,4,9, projection=proj)
plt.title('Salt tendency - \n (advection + horz. diffusion)', fontsize=16)
...
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],ice_draft[xlimit,ylimit],levels=[-.1],linestyles='dashed', transform=ccrs.PlateCarree(), cmap=plt.cm.binary)
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],h[xlimit,ylimit],levels=(200,400,600,800,1000), transform=ccrs.PlateCarree(), colors='grey')
ax9.set_ylabel('WAOM2',fontsize=16)
plt.ylabel('WAOM2',fontsize=16)

ax10 = fig.add_subplot(3,4,10, projection=proj)
plt.title('Salt vert. advection', fontsize=16)
cy=plt.pcolormesh(lon_rho,lat_rho,np.nanmean(salt_vadv_sum, axis=0), transform=ccrs.PlateCarree(), cmap=plt.cm.coolwarm, vmin=-2e-5, vmax=2e-5)
ax10.gridlines()
...
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],ice_draft[xlimit,ylimit],levels=[-.1],linestyles='dashed', transform=ccrs.PlateCarree(), cmap=plt.cm.binary)
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],h[xlimit,ylimit],levels=(200,400,600,800,1000), transform=ccrs.PlateCarree(), colors='grey')
ax10.set_ylabel('WAOM2',fontsize=16)
plt.ylabel('WAOM2',fontsize=16)

ax11 = fig.add_subplot(3,4,11, projection=proj)
plt.title('Salt vert. diffusion', fontsize=16)
cy=plt.pcolormesh(lon_rho,lat_rho,np.nanmean(salt_vdiff_sum, axis=0), transform=ccrs.PlateCarree(), cmap=plt.cm.coolwarm, vmin=-2e-5, vmax=2e-5)
ax11.gridlines()
...
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],ice_draft[xlimit,ylimit],levels=[-.1],linestyles='dashed', transform=ccrs.PlateCarree(), cmap=plt.cm.binary)
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],h[xlimit,ylimit],levels=(200,400,600,800,1000), transform=ccrs.PlateCarree(), colors='grey')
ax11.set_ylabel('WAOM2',fontsize=16)
plt.ylabel('WAOM2',fontsize=16)
...
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],ice_draft[xlimit,ylimit],levels=[-.1],linestyles='dashed', transform=ccrs.PlateCarree(), cmap=plt.cm.binary)
plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],h[xlimit,ylimit],levels=(200,400,600,800,1000), transform=ccrs.PlateCarree(), colors='grey')
ax12.set_ylabel('WAOM2',fontsize=16)
plt.ylabel('WAOM2',fontsize=16)

name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_SemiFull_salt_budget+_annual_yr10_shelf_RFIS_27.3-27.8kgm-3.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
for mm in np.arange(0,12):
    ...
    cy=plt.pcolormesh(lon_rho,lat_rho,salt_net_sum_mm - salt_adv_sum_mm, transform=ccrs.PlateCarree(), cmap=plt.cm.coolwarm)
...
#    plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],h[xlimit,ylimit],levels=(200,400,600,800,1000), transform=ccrs.PlateCarree(), colors='grey')
    ...
    cy=plt.pcolormesh(lon_rho,lat_rho,salt_diff_sum_mm-salt_sfc_sum_mm, transform=ccrs.PlateCarree(), cmap=plt.cm.coolwarm)
    plt.colorbar(cy, extend='both')
    ax3.gridlines()
    lonlat_labels(ax3)
    ax3.set_extent([-85, -30, -84, -74], crs=ccrs.PlateCarree())
    ...
    name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_SemiFull_salt_budget_annual_yr10_shelf_mm=" + str(mm) + "_RFIS_27.3-27.8kgm-3.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
