...
mov_custom.save('/users/boeiradi/COLD_project/postprocessing/figs/WMT/movie/WAOM4extend_WMTmap_salt_budget.mp4', overwrite_existing=True, progress=True, framerate=1)
