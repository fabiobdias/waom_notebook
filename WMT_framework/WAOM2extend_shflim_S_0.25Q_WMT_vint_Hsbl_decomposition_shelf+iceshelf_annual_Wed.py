...
Fs_rate_delta_adv_vint_shelf_noice_Wed_mm = wmt(salt_adv_mld_vint*mask_shelf*mask_zice*mask_Wed, dx, dy,'budget')
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_salt_vint_annual_shelf_noice_Wed.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_heat_vint_annual_shelf_noice_Wed.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
np.savez(npy_path + 'WAOM2extend_WMT_shelf_noice_sfc_total_Wed',rho_grid = rho_grid, F_sig_sfc_shelf_noice_Wed = F_sig_sfc_shelf_noice_Wed)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_noice_sfc_salt_Wed',rho_grid = rho_grid, Fs_sig_sfc_shelf_noice_Wed = Fs_sig_sfc_shelf_noice_Wed)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_noice_sfc_heat_Wed',rho_grid = rho_grid, Fh_sig_sfc_shelf_noice_Wed = Fh_sig_sfc_shelf_noice_Wed)

np.savez(npy_path + 'WAOM2extend_WMT_shelf_noice_vint_salt_net_Wed',rho_grid = rho_grid, Fs_sig_net_vint_shelf_noice_Wed = Fs_sig_net_vint_shelf_noice_Wed)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_noice_vint_salt_diff_Wed',rho_grid = rho_grid, Fs_sig_diff_vint_shelf_noice_Wed = Fs_sig_diff_vint_shelf_noice_Wed)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_noice_vint_salt_adv_Wed',rho_grid = rho_grid, Fs_sig_adv_vint_shelf_noice_Wed = Fs_sig_adv_vint_shelf_noice_Wed)

np.savez(npy_path + 'WAOM2extend_WMT_shelf_noice_vint_heat_net_Wed',rho_grid = rho_grid, Fh_sig_net_vint_shelf_noice_Wed = Fh_sig_net_vint_shelf_noice_Wed)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_noice_vint_heat_diff_Wed',rho_grid = rho_grid, Fh_sig_diff_vint_shelf_noice_Wed = Fh_sig_diff_vint_shelf_noice_Wed)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_noice_vint_heat_adv_Wed',rho_grid = rho_grid, Fh_sig_adv_vint_shelf_noice_Wed = Fh_sig_adv_vint_shelf_noice_Wed)
