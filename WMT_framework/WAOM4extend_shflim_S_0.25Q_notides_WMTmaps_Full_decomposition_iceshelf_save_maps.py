...
fn = '/g/data3/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom4extend_shflim_S_0.25Q/output_yr10_notides_diag/Full_vint_WMTmaps.nc'
...
irho[:] = rho_grid[19:40]
ocean_times[:] = 0 #annual   #np.arange(1314000,31536000,2614000) # monthly
xi[:] = np.arange(0,1575)
