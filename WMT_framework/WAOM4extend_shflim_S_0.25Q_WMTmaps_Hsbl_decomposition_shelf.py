...
name_fig="waom4extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr10_shelf.png"
...
#    plt.clim(-2e-6,2e-6)
    ...
    name_fig="waom4extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr10_shelf_mm=" + str(mm) + ".png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
