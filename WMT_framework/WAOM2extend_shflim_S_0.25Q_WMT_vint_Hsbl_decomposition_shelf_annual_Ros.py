...
name_fig="waom2extend_shflim_S_0.25Q_WMT_salt_vint_annual_shelf_Ros.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_heat_vint_annual_shelf_Ros.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
np.savez(npy_path + 'WAOM2extend_WMT_shelf_sfc_total_Ros',rho_grid = rho_grid, F_sig_sfc_shelf_Ros = F_sig_sfc_shelf_Ros)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_sfc_salt_Ros',rho_grid = rho_grid, Fs_sig_sfc_shelf_Ros = Fs_sig_sfc_shelf_Ros)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_sfc_heat_Ros',rho_grid = rho_grid, Fh_sig_sfc_shelf_Ros = Fh_sig_sfc_shelf_Ros)

np.savez(npy_path + 'WAOM2extend_WMT_shelf_vint_salt_net_Ros',rho_grid = rho_grid, Fs_sig_net_vint_shelf_Ros = Fs_sig_net_vint_shelf_Ros)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_vint_salt_diff_Ros',rho_grid = rho_grid, Fs_sig_diff_vint_shelf_Ros = Fs_sig_diff_vint_shelf_Ros)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_vint_salt_adv_Ros',rho_grid = rho_grid, Fs_sig_adv_vint_shelf_Ros = Fs_sig_adv_vint_shelf_Ros)

np.savez(npy_path + 'WAOM2extend_WMT_shelf_vint_heat_net_Ros',rho_grid = rho_grid, Fh_sig_net_vint_shelf_Ros = Fh_sig_net_vint_shelf_Ros)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_vint_heat_diff_Ros',rho_grid = rho_grid, Fh_sig_diff_vint_shelf_Ros = Fh_sig_diff_vint_shelf_Ros)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_vint_heat_adv_Ros',rho_grid = rho_grid, Fh_sig_adv_vint_shelf_Ros = Fh_sig_adv_vint_shelf_Ros)
