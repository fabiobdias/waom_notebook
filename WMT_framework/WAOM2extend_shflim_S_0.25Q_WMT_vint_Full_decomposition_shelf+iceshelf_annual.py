...
name_fig="waom2extend_shflim_S_0.25Q_WMT_Full_sfc_fluxes_annual_shelf_noice_comparison.png"
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_Full_heat-salt_vint_annual_shelf_noice.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
# call cartopy projection
    ...
    name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_Full_annual_yr10_l" + str(irho)  + "_shelf_noice.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
