...
name_fig="waom2extend_shflim_S_0.25Q_WMT_sfc_fluxes_annual_iceshelf_comparison.png"
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_heat-salt_vint_annual_iceshelf.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
# call cartopy projection
    ...
    name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_annual_yr10_l" + str(irho)  + "_iceshelf.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
...
name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_annual_yr10_iceshelf.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_sfc_total',rho_grid = rho_grid, F_sig_sfc_iceshelf = F_sig_sfc_iceshelf)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_sfc_salt',rho_grid = rho_grid, Fs_sig_sfc_iceshelf = Fs_sig_sfc_iceshelf)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_sfc_heat',rho_grid = rho_grid, Fh_sig_sfc_iceshelf = Fh_sig_sfc_iceshelf)

np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_salt_net',rho_grid = rho_grid, Fs_sig_net_vint_iceshelf = Fs_sig_net_vint_iceshelf)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_salt_diff',rho_grid = rho_grid, Fs_sig_diff_vint_iceshelf = Fs_sig_diff_vint_iceshelf)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_salt_adv',rho_grid = rho_grid, Fs_sig_adv_vint_iceshelf = Fs_sig_adv_vint_iceshelf)

np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_heat_net', rho_grid = rho_grid, Fh_sig_net_vint_iceshelf = Fh_sig_net_vint_iceshelf)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_heat_diff', rho_grid = rho_grid, Fh_sig_diff_vint_iceshelf = Fh_sig_diff_vint_iceshelf)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_heat_adv', rho_grid = rho_grid, Fh_sig_adv_vint_iceshelf = Fh_sig_adv_vint_iceshelf)
