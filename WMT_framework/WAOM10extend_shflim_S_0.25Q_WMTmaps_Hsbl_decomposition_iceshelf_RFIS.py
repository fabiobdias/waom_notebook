...
#Fh_rate_delta_adv_vint_iceshelf_mm = wmt(temp_adv_mld_vint*mask_outice*mask_zice, dx, dy,'budget')
#Fh_rate_delta_diff_vint_iceshelf_mm = wmt(R_t_vint*mask_outice*mask_zice, dx, dy,'budget')
#Fh_rate_delta_net_vint_iceshelf_mm = wmt(temp_net_mld_vint*mask_outice*mask_zice, dx, dy,'budget')
#Fh_rate_delta_sfc_iceshelf_mm = wmt(temp_sfc*mask_outice*mask_zice, dx, dy,'sfc_frc')

Fm_rate_delta_sfc_iceshelf_mm = wmt(beta_mld*m*mask_outice, dx, dy,'sfc_frc')


print('===================================================================================================')
print('Fm_sfc and Fs_sfc shapes:', Fm_rate_delta_sfc_iceshelf_mm.shape, Fs_rate_delta_sfc_iceshelf_mm.shape)
...
name_fig="waom10extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr20_iceshelf_RFIS.png"
...
name_fig="waom10extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr20_basalmelt_iceshelf_RFIS.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
#    plt.clim(-5e-6,5e-6)
    ...
    name_fig="waom10extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr20_iceshelf_mm=" + str(mm) + "_RFIS.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
