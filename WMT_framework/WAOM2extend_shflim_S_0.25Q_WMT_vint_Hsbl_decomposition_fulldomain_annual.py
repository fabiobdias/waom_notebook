...
name_fig="waom2extend_shflim_S_0.25Q_WMT_sfc_fluxes_annual_fulldomain.png"
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_heat-salt_vint_annual_fulldomain.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
# call cartopy projection
    ...
    name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_annual_yr10_l" + str(irho)  + "_fulldomain.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
...
name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_annual_yr10_fulldomain.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
