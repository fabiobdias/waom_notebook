...
name_fig='waom40extend_shflim_S_0.25Q_MLD_OHB_Sep_yr10cp.png'
plt.savefig(fig_path + name_fig, dpi=300)
#plt.show()
plt.close()


fn = '/scratch/project_2000789/boeiradi/waom4extend_shflim_S_0.25Q/output_yr10_diag/MLD_vint_vars_for_WMT_m.s-1_iteractive_copy.nc'
