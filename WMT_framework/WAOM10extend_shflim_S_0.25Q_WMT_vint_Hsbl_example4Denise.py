...
# ------ load heat/salt budget variables vertically-integrated within the MLD
...
# ------ calculate the WMT term following Abernathey et al (2016), eqn. S10 (density), S1 (heat), S2 (salt):
