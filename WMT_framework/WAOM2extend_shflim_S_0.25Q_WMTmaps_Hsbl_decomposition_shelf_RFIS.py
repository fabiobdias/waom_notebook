...
#ax2 = fig.add_subplot(3,3,10, projection=proj)
...
name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr10_shelf_RFIS_27.3-27.8kgm-3.png"
#name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr10_shelf_RFIS.png"
...
#    plt.contour(lon_rho[xlimit,ylimit], lat_rho[xlimit,ylimit],h[xlimit,ylimit],levels=(200,400,600,800,1000), transform=ccrs.PlateCarree(), colors='grey')
    ...
    name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr10_shelf_mm=" + str(mm) + "_RFIS_27.3-27.8kgm-3.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
