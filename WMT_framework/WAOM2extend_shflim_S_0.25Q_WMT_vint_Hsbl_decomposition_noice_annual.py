...
name_fig="waom2extend_shflim_S_0.25Q_WMT_sfc_fluxes_annual_noice.png"
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_heat-salt_vint_annual_noice.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
# call cartopy projection
    ...
    name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_annual_yr10_l" + str(irho)  + "_noice.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
...
name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_annual_yr10_noice.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
