...
Fs_rate_delta_adv_vint_shelf_noice_Ros_mm = wmt(salt_adv_full_vint*mask_shelf*mask_zice*mask_Ros, dx, dy,'budget')
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_Full_salt_vint_annual_shelf_noice_Ros.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_Full_heat_vint_annual_shelf_noice_Ros.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_noice_sfc_total_Ros',rho_grid = rho_grid, F_sig_sfc_shelf_noice_Ros = F_sig_sfc_shelf_noice_Ros)
np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_noice_sfc_salt_Ros',rho_grid = rho_grid, Fs_sig_sfc_shelf_noice_Ros = Fs_sig_sfc_shelf_noice_Ros)
np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_noice_sfc_heat_Ros',rho_grid = rho_grid, Fh_sig_sfc_shelf_noice_Ros = Fh_sig_sfc_shelf_noice_Ros)

np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_noice_vint_salt_net_Ros',rho_grid = rho_grid, Fs_sig_net_vint_shelf_noice_Ros = Fs_sig_net_vint_shelf_noice_Ros)
np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_noice_vint_salt_diff_Ros',rho_grid = rho_grid, Fs_sig_diff_vint_shelf_noice_Ros = Fs_sig_diff_vint_shelf_noice_Ros)
np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_noice_vint_salt_adv_Ros',rho_grid = rho_grid, Fs_sig_adv_vint_shelf_noice_Ros = Fs_sig_adv_vint_shelf_noice_Ros)

np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_noice_vint_heat_net_Ros',rho_grid = rho_grid, Fh_sig_net_vint_shelf_noice_Ros = Fh_sig_net_vint_shelf_noice_Ros)
np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_noice_vint_heat_diff_Ros',rho_grid = rho_grid, Fh_sig_diff_vint_shelf_noice_Ros = Fh_sig_diff_vint_shelf_noice_Ros)
np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_noice_vint_heat_adv_Ros',rho_grid = rho_grid, Fh_sig_adv_vint_shelf_noice_Ros = Fh_sig_adv_vint_shelf_noice_Ros)
