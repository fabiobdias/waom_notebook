...
# allocate SemiFull-integrated variables:
...
for mm in np.arange(0,12):
    ...
    for ii in np.arange(0,2800):
        for jj in np.arange(0,3150):
            
            # for vertically-integrated vars: calculate var*dz_trsp
            # Diffusion
            temp_hdiff_full_dz_trsp = Atemp_hdiff[mm,1:,ii,jj]*dz_trsp[mm,1:,ii,jj]
            temp_vdiff_full_dz_trsp = Atemp_vdiff[mm,1:,ii,jj]*dz_trsp[mm,1:,ii,jj]
            salt_hdiff_full_dz_trsp = Bsalt_hdiff[mm,1:,ii,jj]*dz_trsp[mm,1:,ii,jj]
            salt_vdiff_full_dz_trsp = Bsalt_vdiff[mm,1:,ii,jj]*dz_trsp[mm,1:,ii,jj]
            ...
            # Advection
            temp_hadv_full_dz_trsp = Atemp_hadv[mm,1:,ii,jj]*dz_trsp[mm,1:,ii,jj]
            temp_vadv_full_dz_trsp = Atemp_vadv[mm,1:,ii,jj]*dz_trsp[mm,1:,ii,jj]
            salt_hadv_full_dz_trsp = Bsalt_hadv[mm,1:,ii,jj]*dz_trsp[mm,1:,ii,jj]
            salt_vadv_full_dz_trsp = Bsalt_vadv[mm,1:,ii,jj]*dz_trsp[mm,1:,ii,jj]
            # sum in the vertical
            ...
            # Tendency
            temp_rate_full_dz_trsp = Atemp_rate[mm,1:,ii,jj]*dz_trsp[mm,1:,ii,jj]
            salt_rate_full_dz_trsp = Bsalt_rate[mm,1:,ii,jj]*dz_trsp[mm,1:,ii,jj]
            # sum in the vertical
...
name_fig='waom2extend_shflim_S_0.25Q_SemiFull_OHB_Sep_yr5.png'
...
fn = '/g/data3/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom2extend_shflim_S_0.25Q/output_yr5_diag/SemiFull_vint_vars_for_WMT_m.s-1.nc'
...
temp_vdia_diff_full_vint.units = 'vertical component of temp_diff full depth-integrated (degC s-1)'
salt_vdia_diff_full_vint.units = 'vertical component of salt_diff full depth-integrated (s-1)'
...
temp_hdia_diff_full_vint.units = 'horizontal component of temp_diff full depth-integrated (degC s-1)'
salt_hdia_diff_full_vint.units = 'horizontal component of salt_diff full depth-integrated (s-1)'
# advective terms
...
temp_vdia_adv_full_vint.units = 'vertical component of temp_adv full-depth integrated (degC s-1)'
salt_vdia_adv_full_vint.units = 'vertical component of salt_adv full-depth integrated (s-1)'
...
temp_hdia_adv_full_vint.units = 'horizontal component of temp_adv full-depth integrated (degC s-1)'
salt_hdia_adv_full_vint.units = 'horizontal component of salt_adv full-depth integrated (s-1)'
# tendency terms
