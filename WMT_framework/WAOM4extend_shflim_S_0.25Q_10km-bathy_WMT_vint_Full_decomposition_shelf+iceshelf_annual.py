...
name_fig="waom4extend_shflim_S_0.25Q_10km-bathy_WMT_Full_sfc_fluxes_annual_shelf_noice_comparison.png"
...
name_fig="waom4extend_shflim_S_0.25Q_10km-bathy_WMT_Full_heat-salt_vint_annual_shelf_noice.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
# call cartopy projection
    ...
    name_fig="waom4extend_shflim_S_0.25Q_10km-bathy_WMTmaps_Full_annual_yr10_l" + str(irho)  + "_shelf_noice.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
...
name_fig="waom4extend_shflim_S_0.25Q_10km-bathy_WMTmaps_Full_annual_yr10_shelf_noice.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
np.savez(npy_path + 'WAOM4extend_10km-bathy_Full_WMT_shelf_noice_sfc_total',rho_grid = rho_grid, F_sig_sfc_shelf_noice = F_sig_sfc_shelf_noice)
np.savez(npy_path + 'WAOM4extend_10km-bathy_Full_WMT_shelf_noice_sfc_salt',rho_grid = rho_grid, Fs_sig_sfc_shelf_noice = Fs_sig_sfc_shelf_noice)
np.savez(npy_path + 'WAOM4extend_10km-bathy_Full_WMT_shelf_noice_sfc_heat',rho_grid = rho_grid, Fh_sig_sfc_shelf_noice = Fh_sig_sfc_shelf_noice)

np.savez(npy_path + 'WAOM4extend_10km-bathy_Full_WMT_shelf_noice_vint_salt_net',rho_grid = rho_grid, Fs_sig_net_vint_shelf_noice = Fs_sig_net_vint_shelf_noice)
np.savez(npy_path + 'WAOM4extend_10km-bathy_Full_WMT_shelf_noice_vint_salt_diff',rho_grid = rho_grid, Fs_sig_diff_vint_shelf_noice = Fs_sig_diff_vint_shelf_noice)
np.savez(npy_path + 'WAOM4extend_10km-bathy_Full_WMT_shelf_noice_vint_salt_adv',rho_grid = rho_grid, Fs_sig_adv_vint_shelf_noice = Fs_sig_adv_vint_shelf_noice)

np.savez(npy_path + 'WAOM4extend_10km-bathy_Full_WMT_shelf_noice_vint_heat_net', rho_grid = rho_grid, Fh_sig_net_vint_shelf_noice = Fh_sig_net_vint_shelf_noice)
np.savez(npy_path + 'WAOM4extend_10km-bathy_Full_WMT_shelf_noice_vint_heat_diff', rho_grid = rho_grid, Fh_sig_diff_vint_shelf_noice = Fh_sig_diff_vint_shelf_noice)
np.savez(npy_path + 'WAOM4extend_10km-bathy_Full_WMT_shelf_noice_vint_heat_adv', rho_grid = rho_grid, Fh_sig_adv_vint_shelf_noice = Fh_sig_adv_vint_shelf_noice)
