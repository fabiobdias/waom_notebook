...
for mm in np.arange(0,12):
    ...
    cs=plt.plot(rho_grid,-Fs_sig_sfc_shelf_mm[:,mm] + Fm_sig_sfc_shelf_mm[:,mm],'--c',label='WMT due to salt sfc')
    if mm == 0:
        plt.legend()
...
name_fig="waom10extend_shflim_S_0.25Q_WMT_salt_vint_monthly_shelf.png"
...
name_fig="waom10extend_shflim_S_0.25Q_WMT_heat_vint_monthly_shelf.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
name_fig="waom10extend_shflim_S_0.25Q_WMT_total_vint_monthly_shelf.png"
plt.savefig(fig_path + name_fig, dpi=300)
