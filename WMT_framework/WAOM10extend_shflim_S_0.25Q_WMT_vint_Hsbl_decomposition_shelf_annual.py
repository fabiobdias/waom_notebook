...
name_fig="waom10extend_shflim_S_0.25Q_WMT_sfc_fluxes_annual_shelf.png"
...
np.savez(npy_path + 'WAOM10extend_WMT_shelf_sfc_total',rho_grid = rho_grid, F_sig_sfc_shelf = F_sig_sfc_shelf) 
np.savez(npy_path + 'WAOM10extend_WMT_shelf_sfc_salt',rho_grid = rho_grid, Fs_sig_sfc_shelf = Fs_sig_sfc_shelf) 
np.savez(npy_path + 'WAOM10extend_WMT_shelf_sfc_heat',rho_grid = rho_grid, Fh_sig_sfc_shelf = Fh_sig_sfc_shelf) 

np.savez(npy_path + 'WAOM10extend_WMT_shelf_vint_salt_net',rho_grid = rho_grid, Fs_sig_net_vint_shelf = Fs_sig_net_vint_shelf) 
np.savez(npy_path + 'WAOM10extend_WMT_shelf_vint_salt_diff',rho_grid = rho_grid, Fs_sig_diff_vint_shelf = Fs_sig_diff_vint_shelf)
np.savez(npy_path + 'WAOM10extend_WMT_shelf_vint_salt_adv',rho_grid = rho_grid, Fs_sig_adv_vint_shelf = Fs_sig_adv_vint_shelf)

np.savez(npy_path + 'WAOM10extend_WMT_shelf_vint_heat_net', rho_grid = rho_grid, Fh_sig_net_vint_shelf = Fh_sig_net_vint_shelf)
np.savez(npy_path + 'WAOM10extend_WMT_shelf_vint_heat_diff', rho_grid = rho_grid, Fh_sig_diff_vint_shelf = Fh_sig_diff_vint_shelf)
np.savez(npy_path + 'WAOM10extend_WMT_shelf_vint_heat_adv', rho_grid = rho_grid, Fh_sig_adv_vint_shelf = Fh_sig_adv_vint_shelf)
