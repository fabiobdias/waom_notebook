...
Fm_rate_delta_sfc_mm = wmt(beta_mld*m, dx, dy,'sfc_frc')
...
# call cartopy projection
    ...
    cy=plt.pcolormesh(lon_rho,lat_rho,np.nanmean(Fs_rate_delta_net_vint_mm[:,irho,:], axis=0)*rho0/1e6, transform=ccrs.PlateCarree(), cmap=plt.cm.coolwarm)
    plt.colorbar(cy)
    ...
    cy=plt.pcolormesh(lon_rho,lat_rho,np.nanmean(Fh_rate_delta_net_vint_mm[:,irho,:], axis=0)*rho0/1e6, transform=ccrs.PlateCarree(), cmap=plt.cm.coolwarm)
    plt.colorbar(cy)
    ...
    cy=plt.pcolormesh(lon_rho,lat_rho,np.nanmean(Fh_rate_delta_net_vint_mm[:,irho,:], axis=0)*rho0/1e6+np.nanmean(Fs_rate_delta_net_vint_mm[:,irho,:], axis=0)*rho0/1e6, transform=ccrs.PlateCarree(), cmap=plt.cm.coolwarm)
    plt.colorbar(cy)
    ...
    name_fig="waom10extend_shflim_S_0.25Q_WMTmaps_annual_yr20_l" + str(irho)  + "_fulldomain.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
...
# call cartopy projection
    ...
    name_fig="waom10extend_shflim_S_0.25Q_WMTmaps_annual_yr20_l" + str(irho)  + "_noice.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
...
name_fig="waom10extend_shflim_S_0.25Q_WMTmaps_annual_yr20_fulldomain.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
name_fig="waom10extend_shflim_S_0.25Q_WMTmaps_annual_yr20_noice.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
name_fig="waom10extend_shflim_S_0.25Q_sfc_fluxes_maps_annual_yr20.png"
plt.savefig(fig_path + name_fig, dpi=300)
#plt.close()
