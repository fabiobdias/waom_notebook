...
salt = xr.Dataset(
    ...
    {'time':np.arange(0,12),'eta_rho':dg.eta_rho,'xi_rho':dg.xi_rho})
...
mov_custom.save('/g/data3/hh5/tmp/access-om/fbd581/ROMS/postprocessing/figs/WMT/movie/WAOM2extend_WMTmap_salt_budget.mp4', overwrite_existing=True, progress=True, framerate=1)
