...
Fs_rate_delta_adv_vint_iceshelf_EAnt_mm = wmt(salt_adv_mld_vint*mask_outice*mask_EAnt, dx, dy,'budget')
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_salt_vint_annual_iceshelf_EAnt.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_heat_vint_annual_iceshelf_EAnt.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_sfc_total_EAnt',rho_grid = rho_grid, F_sig_sfc_iceshelf_EAnt = F_sig_sfc_iceshelf_EAnt)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_sfc_salt_EAnt',rho_grid = rho_grid, Fs_sig_sfc_iceshelf_EAnt = Fs_sig_sfc_iceshelf_EAnt)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_sfc_heat_EAnt',rho_grid = rho_grid, Fh_sig_sfc_iceshelf_EAnt = Fh_sig_sfc_iceshelf_EAnt)

np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_salt_net_EAnt',rho_grid = rho_grid, Fs_sig_net_vint_iceshelf_EAnt = Fs_sig_net_vint_iceshelf_EAnt)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_salt_diff_EAnt',rho_grid = rho_grid, Fs_sig_diff_vint_iceshelf_EAnt = Fs_sig_diff_vint_iceshelf_EAnt)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_salt_adv_EAnt',rho_grid = rho_grid, Fs_sig_adv_vint_iceshelf_EAnt = Fs_sig_adv_vint_iceshelf_EAnt)

np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_heat_net_EAnt',rho_grid = rho_grid, Fh_sig_net_vint_iceshelf_EAnt = Fh_sig_net_vint_iceshelf_EAnt)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_heat_diff_EAnt',rho_grid = rho_grid, Fh_sig_diff_vint_iceshelf_EAnt = Fh_sig_diff_vint_iceshelf_EAnt)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_heat_adv_EAnt',rho_grid = rho_grid, Fh_sig_adv_vint_iceshelf_EAnt = Fh_sig_adv_vint_iceshelf_EAnt)
