...
name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr10_iceshelf_RFIS.png"
...
name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr20_basalmelt_iceshelf_RFIS.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
#    plt.clim(-5e-6,5e-6)
    ...
    name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr10_iceshelf_mm=" + str(mm) + "_RFIS.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
