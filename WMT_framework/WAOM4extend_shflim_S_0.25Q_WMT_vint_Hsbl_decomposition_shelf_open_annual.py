...
name_fig="waom4extend_shflim_S_0.25Q_WMT_sfc_fluxes_annual_shelf_open_comparison.png"
...
name_fig="waom4extend_shflim_S_0.25Q_WMT_heat-salt_vint_annual_shelf.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
name_fig="waom4extend_shflim_S_0.25Q_WMT_heat-salt_vint_annual_open.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
# call cartopy projection
    ...
    name_fig="waom4extend_shflim_S_0.25Q_WMTmaps_annual_yr10_l" + str(irho)  + "_shelf.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
...
# call cartopy projection
    ...
    name_fig="waom4extend_shflim_S_0.25Q_WMTmaps_annual_yr10_l" + str(irho)  + "_open.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
...
name_fig="waom4extend_shflim_S_0.25Q_WMTmaps_annual_yr10_shelf.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
name_fig="waom4extend_shflim_S_0.25Q_WMTmaps_annual_yr10_open.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
