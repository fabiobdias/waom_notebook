...
Fm_sig_sfc_shelf_mm = -Fm_rate_sfc_shelf_mm_int*Dt/1e6
...
# SFC: open ocean
Fs_sig_sfc_open_mm = -Fs_rate_sfc_open_mm_int*Dt/1e6
Fm_sig_sfc_open_mm = -Fm_rate_sfc_open_mm_int*Dt/1e6 
Fh_sig_sfc_open_mm = -Fh_rate_sfc_open_mm_int*Dt/1e6 
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_sfc_fluxes_annual_shelf_open_comparison.png"
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_heat-salt_vint_annual_shelf.png"
plt.savefig(fig_path + name_fig, dpi=300)

# ADV (vint)
Fs_sig_adv_vint_open_mm = -Fs_rate_adv_vint_open_mm_int*Dt/1e6 
Fh_sig_adv_vint_open_mm = -Fh_rate_adv_vint_open_mm_int*Dt/1e6 
...
# DIFF
Fs_sig_diff_vint_open_mm = -Fs_rate_diff_vint_open_mm_int*Dt/1e6 
Fh_sig_diff_vint_open_mm = -Fh_rate_diff_vint_open_mm_int*Dt/1e6 
...
# NET
Fs_sig_net_vint_open_mm = -Fs_rate_net_vint_open_mm_int*Dt/1e6 
Fh_sig_net_vint_open_mm = -Fh_rate_net_vint_open_mm_int*Dt/1e6 
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_heat-salt_vint_annual_open.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
# call cartopy projection
    ...
    name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_annual_yr10_l" + str(irho)  + "_shelf.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
...
# call cartopy projection
    ...
    ax2 = fig.add_subplot(222, projection=proj)
    plt.title('FWF, $\sigma_{\Theta}$ = ' + str(rho_grid[irho]))
    cy=plt.pcolormesh(lon_rho,lat_rho,np.nanmean(-Fs_rate_delta_net_vint_open_mm[:,irho,:], axis=0)*Dt/1e6, transform=ccrs.PlateCarree(), cmap=plt.cm.coolwarm)
    plt.colorbar(cy)
    ax2.gridlines() # draw_labels=True,linewidth=2, color='white', alpha=0.5, linestyle='--')
    lonlat_labels(ax2)
    ax2.set_extent([-180, 180, -90, -60], crs=ccrs.PlateCarree())
    ...
    ax3 = fig.add_subplot(223, projection=proj)
    plt.title('HF, $\sigma_{\Theta}$ = ' + str(rho_grid[irho]))
    cy=plt.pcolormesh(lon_rho,lat_rho,np.nanmean(Fh_rate_delta_net_vint_open_mm[:,irho,:], axis=0)*Dt/1e6, transform=ccrs.PlateCarree(), cmap=plt.cm.coolwarm)
    plt.colorbar(cy)
    ax3.gridlines() # draw_labels=True,linewidth=2, color='white', alpha=0.5, linestyle='--')
    lonlat_labels(ax3)
    ax3.set_extent([-180, 180, -90, -60], crs=ccrs.PlateCarree())
    ...
    ax4 = fig.add_subplot(224, projection=proj)
    plt.title('Total, $\sigma_{\Theta}$ = ' + str(rho_grid[irho]))
    cy=plt.pcolormesh(lon_rho,lat_rho,np.nanmean(Fh_rate_delta_net_vint_open_mm[:,irho,:], axis=0)*Dt/1e6+np.nanmean(-Fs_rate_delta_net_vint_open_mm[:,irho,:], axis=0)*Dt/1e6, transform=ccrs.PlateCarree(), cmap=plt.cm.coolwarm)
    plt.colorbar(cy)
    ax4.gridlines() # draw_labels=True,linewidth=2, color='white', alpha=0.5, linestyle='--')
    lonlat_labels(ax4)
    ax4.set_extent([-180, 180, -90, -60], crs=ccrs.PlateCarree())
    ...
    name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_annual_yr10_l" + str(irho)  + "_open.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
...
name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_annual_yr10_shelf.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
name_fig="waom2extend_shflim_S_0.25Q_WMTmaps_annual_yr10_open.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
