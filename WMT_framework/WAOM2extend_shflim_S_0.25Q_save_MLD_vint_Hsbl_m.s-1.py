...
name_fig='waom2extend_shflim_S_0.25Q_MLD_yr5.png'
...
name_fig='waom2extend_shflim_S_0.25Q_MLD_TS_Jan_yr5.png'
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
name_fig='waom2extend_shflim_S_0.25Q_MLD_TS_Sep_yr5.png'
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
name_fig='waom2extend_shflim_S_0.25Q_MLD_OHB_Sep_yr5.png'
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
fn = '/g/data3/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom2extend_shflim_S_0.25Q/output_yr5_diag/MLD_vint_vars_for_WMT_m.s-1.nc'
