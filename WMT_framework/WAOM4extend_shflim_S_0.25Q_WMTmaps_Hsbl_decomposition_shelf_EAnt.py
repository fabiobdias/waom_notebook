...
ax2.gridlines()
lonlat_labels(ax2)
ax2.set_extent([60, 160, -70, -62], crs=ccrs.PlateCarree())
...
ax3.gridlines()
lonlat_labels(ax3)
ax3.set_extent([60, 160, -70, -62], crs=ccrs.PlateCarree())
...
name_fig="waom4extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr10_shelf_EAnt.png"
...
#    plt.clim(-2e-6,2e-6)
    ...
    name_fig="waom4extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr10_shelf_mm=" + str(mm) + "_EAnt.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
