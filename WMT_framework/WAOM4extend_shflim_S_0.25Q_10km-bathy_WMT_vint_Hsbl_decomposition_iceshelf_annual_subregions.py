...
Fs_rate_delta_adv_vint_iceshelf_Wed_mm = wmt(salt_adv_mld_vint*mask_outice*mask_Wed*mask_Wed, dx, dy,'budget')
Fs_rate_delta_diff_vint_iceshelf_Wed_mm = wmt(R_s_vint*mask_outice*mask_Wed, dx, dy,'budget')
Fs_rate_delta_net_vint_iceshelf_Wed_mm = wmt(salt_net_mld_vint*mask_outice*mask_Wed, dx, dy,'budget')
Fs_rate_delta_sfc_iceshelf_Wed_mm = wmt(salt_sfc*mask_outice*mask_Wed, dx, dy,'sfc_frc')

Fh_rate_delta_adv_vint_iceshelf_Wed_mm = wmt(temp_adv_mld_vint*mask_outice*mask_Wed, dx, dy,'budget')
Fh_rate_delta_diff_vint_iceshelf_Wed_mm = wmt(R_t_vint*mask_outice*mask_Wed, dx, dy,'budget')
Fh_rate_delta_net_vint_iceshelf_Wed_mm = wmt(temp_net_mld_vint*mask_outice*mask_Wed, dx, dy,'budget')
...
Fs_rate_delta_adv_vint_iceshelf_Mau_mm = wmt(salt_adv_mld_vint*mask_outice*mask_Mau*mask_Mau, dx, dy,'budget')
Fs_rate_delta_diff_vint_iceshelf_Mau_mm = wmt(R_s_vint*mask_outice*mask_Mau, dx, dy,'budget')
Fs_rate_delta_net_vint_iceshelf_Mau_mm = wmt(salt_net_mld_vint*mask_outice*mask_Mau, dx, dy,'budget')
Fs_rate_delta_sfc_iceshelf_Mau_mm = wmt(salt_sfc*mask_outice*mask_Mau, dx, dy,'sfc_frc')

Fh_rate_delta_adv_vint_iceshelf_Mau_mm = wmt(temp_adv_mld_vint*mask_outice*mask_Mau, dx, dy,'budget')
Fh_rate_delta_diff_vint_iceshelf_Mau_mm = wmt(R_t_vint*mask_outice*mask_Mau, dx, dy,'budget')
Fh_rate_delta_net_vint_iceshelf_Mau_mm = wmt(temp_net_mld_vint*mask_outice*mask_Mau, dx, dy,'budget')
...
Fs_rate_delta_adv_vint_iceshelf_EAnt_mm = wmt(salt_adv_mld_vint*mask_outice*mask_EAnt*mask_EAnt, dx, dy,'budget')
Fs_rate_delta_diff_vint_iceshelf_EAnt_mm = wmt(R_s_vint*mask_outice*mask_EAnt, dx, dy,'budget')
Fs_rate_delta_net_vint_iceshelf_EAnt_mm = wmt(salt_net_mld_vint*mask_outice*mask_EAnt, dx, dy,'budget')
Fs_rate_delta_sfc_iceshelf_EAnt_mm = wmt(salt_sfc*mask_outice*mask_EAnt, dx, dy,'sfc_frc')

Fh_rate_delta_adv_vint_iceshelf_EAnt_mm = wmt(temp_adv_mld_vint*mask_outice*mask_EAnt, dx, dy,'budget')
Fh_rate_delta_diff_vint_iceshelf_EAnt_mm = wmt(R_t_vint*mask_outice*mask_EAnt, dx, dy,'budget')
Fh_rate_delta_net_vint_iceshelf_EAnt_mm = wmt(temp_net_mld_vint*mask_outice*mask_EAnt, dx, dy,'budget')
...
Fs_rate_delta_adv_vint_iceshelf_Ros_mm = wmt(salt_adv_mld_vint*mask_outice*mask_Ros*mask_Ros, dx, dy,'budget')
Fs_rate_delta_diff_vint_iceshelf_Ros_mm = wmt(R_s_vint*mask_outice*mask_Ros, dx, dy,'budget')
Fs_rate_delta_net_vint_iceshelf_Ros_mm = wmt(salt_net_mld_vint*mask_outice*mask_Ros, dx, dy,'budget')
Fs_rate_delta_sfc_iceshelf_Ros_mm = wmt(salt_sfc*mask_outice*mask_Ros, dx, dy,'sfc_frc')

Fh_rate_delta_adv_vint_iceshelf_Ros_mm = wmt(temp_adv_mld_vint*mask_outice*mask_Ros, dx, dy,'budget')
Fh_rate_delta_diff_vint_iceshelf_Ros_mm = wmt(R_t_vint*mask_outice*mask_Ros, dx, dy,'budget')
Fh_rate_delta_net_vint_iceshelf_Ros_mm = wmt(temp_net_mld_vint*mask_outice*mask_Ros, dx, dy,'budget')
...
Fs_rate_delta_adv_vint_iceshelf_WAnt_mm = wmt(salt_adv_mld_vint*mask_outice*mask_WAnt*mask_WAnt, dx, dy,'budget')
Fs_rate_delta_diff_vint_iceshelf_WAnt_mm = wmt(R_s_vint*mask_outice*mask_WAnt, dx, dy,'budget')
Fs_rate_delta_net_vint_iceshelf_WAnt_mm = wmt(salt_net_mld_vint*mask_outice*mask_WAnt, dx, dy,'budget')
Fs_rate_delta_sfc_iceshelf_WAnt_mm = wmt(salt_sfc*mask_outice*mask_WAnt, dx, dy,'sfc_frc')

Fh_rate_delta_adv_vint_iceshelf_WAnt_mm = wmt(temp_adv_mld_vint*mask_outice*mask_WAnt, dx, dy,'budget')
Fh_rate_delta_diff_vint_iceshelf_WAnt_mm = wmt(R_t_vint*mask_outice*mask_WAnt, dx, dy,'budget')
Fh_rate_delta_net_vint_iceshelf_WAnt_mm = wmt(temp_net_mld_vint*mask_outice*mask_WAnt, dx, dy,'budget')
...
name_fig="waom4extend_shflim_S_0.25Q_10km-bathy_WMT_salt_vint_annual_iceshelf_subregions.png"
...
name_fig="waom4extend_shflim_S_0.25Q_10km-bathy_WMT_heat_vint_annual_iceshelf_subregions.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
np.savez(npy_path + 'WAOM4extend_10km-bathy_WMT_iceshelf_sfc_total_subregions',rho_grid = rho_grid, F_sig_sfc_iceshelf_Wed = F_sig_sfc_iceshelf_Wed, F_sig_sfc_iceshelf_Mau = F_sig_sfc_iceshelf_Mau, \
...
np.savez(npy_path + 'WAOM4extend_10km-bathy_WMT_iceshelf_sfc_salt_subregions',rho_grid = rho_grid, Fs_sig_sfc_iceshelf_Wed = Fs_sig_sfc_iceshelf_Wed, Fs_sig_sfc_iceshelf_Mau = Fs_sig_sfc_iceshelf_Mau, \
...
np.savez(npy_path + 'WAOM4extend_10km-bathy_WMT_iceshelf_sfc_heat_subregions',rho_grid = rho_grid, Fh_sig_sfc_iceshelf_Wed = Fh_sig_sfc_iceshelf_Wed, Fh_sig_sfc_iceshelf_Mau = Fh_sig_sfc_iceshelf_Mau, \
...
np.savez(npy_path + 'WAOM4extend_10km-bathy_WMT_iceshelf_vint_salt_net_subregions',rho_grid = rho_grid, Fs_sig_net_vint_iceshelf_Wed = Fs_sig_net_vint_iceshelf_Wed, Fs_sig_net_vint_iceshelf_Mau = Fs_sig_net_vint_iceshelf_Mau, \
...
np.savez(npy_path + 'WAOM4extend_10km-bathy_WMT_iceshelf_vint_salt_diff_subregions',rho_grid = rho_grid, Fs_sig_diff_vint_iceshelf_Wed = Fs_sig_diff_vint_iceshelf_Wed, Fs_sig_diff_vint_iceshelf_Mau = Fs_sig_diff_vint_iceshelf_Mau, \
...
np.savez(npy_path + 'WAOM4extend_10km-bathy_WMT_iceshelf_vint_salt_adv_subregions',rho_grid = rho_grid, Fs_sig_adv_vint_iceshelf_Wed = Fs_sig_adv_vint_iceshelf_Wed, Fs_sig_adv_vint_iceshelf_Mau = Fs_sig_adv_vint_iceshelf_Mau, \
...
np.savez(npy_path + 'WAOM4extend_10km-bathy_WMT_iceshelf_vint_heat_net_subregions',rho_grid = rho_grid, Fh_sig_net_vint_iceshelf_Wed = Fh_sig_net_vint_iceshelf_Wed, Fh_sig_net_vint_iceshelf_Mau = Fh_sig_net_vint_iceshelf_Mau, \
...
np.savez(npy_path + 'WAOM4extend_10km-bathy_WMT_iceshelf_vint_heat_diff_subregions',rho_grid = rho_grid, Fh_sig_diff_vint_iceshelf_Wed = Fh_sig_diff_vint_iceshelf_Wed, Fh_sig_diff_vint_iceshelf_Mau = Fh_sig_diff_vint_iceshelf_Mau, \
...
np.savez(npy_path + 'WAOM4extend_10km-bathy_WMT_iceshelf_vint_heat_adv_subregions',rho_grid = rho_grid, Fh_sig_adv_vint_iceshelf_Wed = Fh_sig_adv_vint_iceshelf_Wed, Fh_sig_adv_vint_iceshelf_Mau = Fh_sig_adv_vint_iceshelf_Mau, \
