...
for mm  in ['01','02','03','04','05','06','07','08','09','10','11','12']:
    ds = xr.open_dataset('/scratch/gh9/fbd581/ROMS/waom4extend_shflim_S_0.25Q/output_yr10_10km-bathy_diag/ocean_avg_00' + mm + '.nc')
...
fig_path = '/g/data3/hh5/tmp/access-om/fbd581/ROMS/postprocessing/figs/MLD/'
name_fig='waom4extend_shflim_S_0.25Q_10km-bathy_MLD_yr10.png'
...
name_fig='waom4extend_shflim_S_0.25Q_10km-bathy_MLD_TS_Jan_yr10.png'
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
name_fig='waom4extend_shflim_S_0.25Q_10km-bathy_MLD_TS_Sep_yr10.png'
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
for mm  in ['01','02','03','04','05','06','07','08','09','10','11','12']:
    dd = xr.open_dataset('/scratch/gh9/fbd581/ROMS/waom4extend_shflim_S_0.25Q/output_yr10_10km-bathy_diag/ocean_dia_00' + mm + '.nc')
...
fn = '/scratch/gh9/fbd581/ROMS/waom4extend_shflim_S_0.25Q/output_yr10_10km-bathy_diag/MLD_vint_vars_for_WMTi_m.s-1.nc'
