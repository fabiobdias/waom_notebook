...
name_fig="waom2extend_shflim_S_0.25Q_WMT_salt_vint_annual_shelf_WAnt.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_heat_vint_annual_shelf_WAnt.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
np.savez(npy_path + 'WAOM2extend_WMT_shelf_sfc_total_WAnt',rho_grid = rho_grid, F_sig_sfc_shelf_WAnt = F_sig_sfc_shelf_WAnt)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_sfc_salt_WAnt',rho_grid = rho_grid, Fs_sig_sfc_shelf_WAnt = Fs_sig_sfc_shelf_WAnt)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_sfc_heat_WAnt',rho_grid = rho_grid, Fh_sig_sfc_shelf_WAnt = Fh_sig_sfc_shelf_WAnt)

np.savez(npy_path + 'WAOM2extend_WMT_shelf_vint_salt_net_WAnt',rho_grid = rho_grid, Fs_sig_net_vint_shelf_WAnt = Fs_sig_net_vint_shelf_WAnt)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_vint_salt_diff_WAnt',rho_grid = rho_grid, Fs_sig_diff_vint_shelf_WAnt = Fs_sig_diff_vint_shelf_WAnt)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_vint_salt_adv_WAnt',rho_grid = rho_grid, Fs_sig_adv_vint_shelf_WAnt = Fs_sig_adv_vint_shelf_WAnt)

np.savez(npy_path + 'WAOM2extend_WMT_shelf_vint_heat_net_WAnt',rho_grid = rho_grid, Fh_sig_net_vint_shelf_WAnt = Fh_sig_net_vint_shelf_WAnt)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_vint_heat_diff_WAnt',rho_grid = rho_grid, Fh_sig_diff_vint_shelf_WAnt = Fh_sig_diff_vint_shelf_WAnt)
np.savez(npy_path + 'WAOM2extend_WMT_shelf_vint_heat_adv_WAnt',rho_grid = rho_grid, Fh_sig_adv_vint_shelf_WAnt = Fh_sig_adv_vint_shelf_WAnt)
