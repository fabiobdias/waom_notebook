...
Fs_rate_delta_adv_vint_iceshelf_Wed_mm = wmt(salt_adv_mld_vint*mask_outice*mask_Wed, dx, dy,'budget')
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_salt_vint_annual_iceshelf_Wed.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_heat_vint_annual_iceshelf_Wed.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_sfc_total_Wed',rho_grid = rho_grid, F_sig_sfc_iceshelf_Wed = F_sig_sfc_iceshelf_Wed)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_sfc_salt_Wed',rho_grid = rho_grid, Fs_sig_sfc_iceshelf_Wed = Fs_sig_sfc_iceshelf_Wed)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_sfc_heat_Wed',rho_grid = rho_grid, Fh_sig_sfc_iceshelf_Wed = Fh_sig_sfc_iceshelf_Wed)

np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_salt_net_Wed',rho_grid = rho_grid, Fs_sig_net_vint_iceshelf_Wed = Fs_sig_net_vint_iceshelf_Wed)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_salt_diff_Wed',rho_grid = rho_grid, Fs_sig_diff_vint_iceshelf_Wed = Fs_sig_diff_vint_iceshelf_Wed)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_salt_adv_Wed',rho_grid = rho_grid, Fs_sig_adv_vint_iceshelf_Wed = Fs_sig_adv_vint_iceshelf_Wed)

np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_heat_net_Wed',rho_grid = rho_grid, Fh_sig_net_vint_iceshelf_Wed = Fh_sig_net_vint_iceshelf_Wed)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_heat_diff_Wed',rho_grid = rho_grid, Fh_sig_diff_vint_iceshelf_Wed = Fh_sig_diff_vint_iceshelf_Wed)
np.savez(npy_path + 'WAOM2extend_WMT_iceshelf_vint_heat_adv_Wed',rho_grid = rho_grid, Fh_sig_adv_vint_iceshelf_Wed = Fh_sig_adv_vint_iceshelf_Wed)
