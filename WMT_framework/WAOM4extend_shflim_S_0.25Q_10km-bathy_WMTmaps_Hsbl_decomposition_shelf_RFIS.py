...
name_fig="waom4extend_shflim_S_0.25Q_10km-bathy_WMTmaps_salt_budget_annual_yr10_shelf_RFIS_27.3-27.8kgm-3.png"
...
#    name_fig="waom4extend_shflim_S_0.25Q_10km-bathy_WMTmaps_salt_budget_annual_yr10_shelf_mm=" + str(mm) + "_RFIS_27.5kgm-3.png"
    name_fig="waom4extend_shflim_S_0.25Q_10km-bathy_WMTmaps_salt_budget_annual_yr10_shelf_mm=" + str(mm) + "_RFIS_27.3-27.6kgm-3.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
