...
Fs_rate_delta_adv_vint_iceshelf_WAnt_mm = wmt(salt_adv_full_vint*mask_outice*mask_WAnt, dx, dy,'budget')
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_Full_salt_vint_annual_iceshelf_WAnt.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_Full_heat_vint_annual_iceshelf_WAnt.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_sfc_total_WAnt',rho_grid = rho_grid, F_sig_sfc_iceshelf_WAnt = F_sig_sfc_iceshelf_WAnt)
np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_sfc_salt_WAnt',rho_grid = rho_grid, Fs_sig_sfc_iceshelf_WAnt = Fs_sig_sfc_iceshelf_WAnt)
np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_sfc_heat_WAnt',rho_grid = rho_grid, Fh_sig_sfc_iceshelf_WAnt = Fh_sig_sfc_iceshelf_WAnt)

np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_vint_salt_net_WAnt',rho_grid = rho_grid, Fs_sig_net_vint_iceshelf_WAnt = Fs_sig_net_vint_iceshelf_WAnt)
np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_vint_salt_diff_WAnt',rho_grid = rho_grid, Fs_sig_diff_vint_iceshelf_WAnt = Fs_sig_diff_vint_iceshelf_WAnt)
np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_vint_salt_adv_WAnt',rho_grid = rho_grid, Fs_sig_adv_vint_iceshelf_WAnt = Fs_sig_adv_vint_iceshelf_WAnt)

np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_vint_heat_net_WAnt',rho_grid = rho_grid, Fh_sig_net_vint_iceshelf_WAnt = Fh_sig_net_vint_iceshelf_WAnt)
np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_vint_heat_diff_WAnt',rho_grid = rho_grid, Fh_sig_diff_vint_iceshelf_WAnt = Fh_sig_diff_vint_iceshelf_WAnt)
np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_vint_heat_adv_WAnt',rho_grid = rho_grid, Fh_sig_adv_vint_iceshelf_WAnt = Fh_sig_adv_vint_iceshelf_WAnt)
