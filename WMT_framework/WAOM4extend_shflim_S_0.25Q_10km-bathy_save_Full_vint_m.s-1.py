...
dg = xr.open_dataset("/g/data3/hh5/tmp/access-om/fbd581/ROMS/waom4_frc/waom4extend_grd_10km-bathym.nc")
...
for mm  in ['01','02','03','04','05','06','07','08','09','10','11','12']:
    dd = xr.open_dataset('/g/data3/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom4extend_shflim_S_0.25Q/output_yr10_10km-bathy_diag/ocean_dia_00' + mm + '.nc')
...
# allocate Full-integrated variables:
...
name_fig='waom4extend_shflim_S_0.25Q_notides_MLD_OHB_Sep_yr10.png'
...
fn = '/g/data3/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom4extend_shflim_S_0.25Q/output_yr10_10km-bathy_diag/Full_vint_vars_for_WMT_m.s-1.nc'
...
temp_hdia_adv_full_vint.units = 'horizontal componentof temp_adv full-depth integrated (degC s-1)'
salt_hdia_adv_full_vint.units = 'horizontal componentof salt_adv full-depth integrated (s-1)'
# tendency terms
