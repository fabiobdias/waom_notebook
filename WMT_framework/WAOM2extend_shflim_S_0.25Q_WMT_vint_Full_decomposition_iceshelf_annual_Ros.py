...
Fs_rate_delta_adv_vint_iceshelf_Ros_mm = wmt(salt_adv_full_vint*mask_outice*mask_Ros, dx, dy,'budget')
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_Full_salt_vint_annual_iceshelf_Ros.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_Full_heat_vint_annual_iceshelf_Ros.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_sfc_total_Ros',rho_grid = rho_grid, F_sig_sfc_iceshelf_Ros = F_sig_sfc_iceshelf_Ros)
np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_sfc_salt_Ros',rho_grid = rho_grid, Fs_sig_sfc_iceshelf_Ros = Fs_sig_sfc_iceshelf_Ros)
np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_sfc_heat_Ros',rho_grid = rho_grid, Fh_sig_sfc_iceshelf_Ros = Fh_sig_sfc_iceshelf_Ros)

np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_vint_salt_net_Ros',rho_grid = rho_grid, Fs_sig_net_vint_iceshelf_Ros = Fs_sig_net_vint_iceshelf_Ros)
np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_vint_salt_diff_Ros',rho_grid = rho_grid, Fs_sig_diff_vint_iceshelf_Ros = Fs_sig_diff_vint_iceshelf_Ros)
np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_vint_salt_adv_Ros',rho_grid = rho_grid, Fs_sig_adv_vint_iceshelf_Ros = Fs_sig_adv_vint_iceshelf_Ros)

np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_vint_heat_net_Ros',rho_grid = rho_grid, Fh_sig_net_vint_iceshelf_Ros = Fh_sig_net_vint_iceshelf_Ros)
np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_vint_heat_diff_Ros',rho_grid = rho_grid, Fh_sig_diff_vint_iceshelf_Ros = Fh_sig_diff_vint_iceshelf_Ros)
np.savez(npy_path + 'WAOM2extend_Full_WMT_iceshelf_vint_heat_adv_Ros',rho_grid = rho_grid, Fh_sig_adv_vint_iceshelf_Ros = Fh_sig_adv_vint_iceshelf_Ros)
