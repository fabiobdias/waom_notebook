...
name_fig="waom2extend_shflim_S_0.25Q_WMT_Full_salt_vint_annual_shelf_Mau.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
name_fig="waom2extend_shflim_S_0.25Q_WMT_Full_heat_vint_annual_shelf_Mau.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_sfc_total_Mau',rho_grid = rho_grid, F_sig_sfc_shelf_Mau = F_sig_sfc_shelf_Mau)
np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_sfc_salt_Mau',rho_grid = rho_grid, Fs_sig_sfc_shelf_Mau = Fs_sig_sfc_shelf_Mau)
np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_sfc_heat_Mau',rho_grid = rho_grid, Fh_sig_sfc_shelf_Mau = Fh_sig_sfc_shelf_Mau)

np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_vint_salt_net_Mau',rho_grid = rho_grid, Fs_sig_net_vint_shelf_Mau = Fs_sig_net_vint_shelf_Mau)
np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_vint_salt_diff_Mau',rho_grid = rho_grid, Fs_sig_diff_vint_shelf_Mau = Fs_sig_diff_vint_shelf_Mau)
np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_vint_salt_adv_Mau',rho_grid = rho_grid, Fs_sig_adv_vint_shelf_Mau = Fs_sig_adv_vint_shelf_Mau)

np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_vint_heat_net_Mau',rho_grid = rho_grid, Fh_sig_net_vint_shelf_Mau = Fh_sig_net_vint_shelf_Mau)
np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_vint_heat_diff_Mau',rho_grid = rho_grid, Fh_sig_diff_vint_shelf_Mau = Fh_sig_diff_vint_shelf_Mau)
np.savez(npy_path + 'WAOM2extend_Full_WMT_shelf_vint_heat_adv_Mau',rho_grid = rho_grid, Fh_sig_adv_vint_shelf_Mau = Fh_sig_adv_vint_shelf_Mau)
