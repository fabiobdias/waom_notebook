...
ax1.set_ylabel('WAOM10',fontsize=14)
...
cbar_ax1.set_xlabel('Transformation rates (Sv)', fontsize=16)#, labelpad=-35)
...
name_fig="waom10extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr20_shelf_RFIS_27.3-27.6kgm-3.png"
...
#    name_fig="waom10extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr20_shelf_mm=" + str(mm) + "_RFIS_27.5kgm-3.png"
    name_fig="waom10extend_shflim_S_0.25Q_WMTmaps_salt_budget_annual_yr20_shelf_mm=" + str(mm) + "_RFIS_27.3-27.6kgm-3.png"
    plt.savefig(fig_path + name_fig, dpi=300)
    plt.close()
