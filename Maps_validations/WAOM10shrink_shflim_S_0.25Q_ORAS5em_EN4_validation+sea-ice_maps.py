...
#ds = xr.open_dataset("/g/data3/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom10shrink_shflim_S_0.25Q_ORAS5em/output_01-20yr/ocean_avg_0017.nc")
...
name_fig = 'waom10shrink_shflim_S_0.25Q_ORAS5emxEN4_surface_TS_annual_yr20.png'
...
# tmp indexes = [-0.50012107 -0.56695557 -0.72814941 -0.88723755 -1.03244019 -1.19348145
# -1.2956543  -1.37216187 -1.39517212 -1.41229248 -1.45117188 -1.45770264
# -1.44744873 -1.46252441 -1.40313721 -1.37107031 -1.30090332 -1.19299316
...
name_fig ='waom10shrink_shflim_S_0.25Q_ORAS5emxEN4_bottom_TS_annual_yr20.png'
plt.savefig(fig_path + name_fig, dpi=300)
...
for mm in np.arange(0,12):
    ...
    name_fig='waom10shrink_shflim_S_0.25Q_ORAS5emxEN4_surface_TS_m=' + month + '_yr20.png'
...
for mm in np.arange(0,12):
    ...
    name_fig='waom10shrink_shflim_S_0.25Q_ORAS5emxEN4_bottom_TS_m=' + month + '_yr20.png'
    plt.savefig(fig_path + name_fig, dpi=300)
