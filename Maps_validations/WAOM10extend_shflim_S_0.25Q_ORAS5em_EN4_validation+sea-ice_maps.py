...
#ds = xr.open_dataset("/g/data3/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom10extend_shflim_S_0.25Q_ORAS5em/output_01-20yr/ocean_avg_0017.nc")
...
name_fig = 'waom10extend_shflim_S_0.25Q_ORAS5emxEN4_surface_TS_annual_yr10.png'
...
name_fig ='waom10extend_shflim_S_0.25Q_ORAS5emxEN4_bottom_TS_annual_yr10.png'
plt.savefig(fig_path + name_fig, dpi=300)
...
for mm in np.arange(0,12):
    ...
    name_fig='waom10extend_shflim_S_0.25Q_ORAS5emxEN4_surface_TS_m=' + month + '_yr10.png'
...
for mm in np.arange(0,12):
    ...
    name_fig='waom10extend_shflim_S_0.25Q_ORAS5emxEN4_bottom_TS_m=' + month + '_yr10.png'
    plt.savefig(fig_path + name_fig, dpi=300)
