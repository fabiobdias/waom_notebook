...
ax1.add_feature(cfeature.LAND, zorder=4, facecolor='white')
...
plt.text(-61,-65,'FRIS',weight='bold', color='w', transform=ccrs.PlateCarree(), fontsize=9)
...
plt.text(158,-61,'East Antarct.',weight='bold', color='w', transform=ccrs.PlateCarree(), fontsize=9)
...
plt.text(-115,-63,'West \n Antarct.',weight='bold', color='w', transform=ccrs.PlateCarree(), fontsize=9)
plt.title('Bottom temperature \n WAOM10')
...
ax2.set_aspect(abs((x_right-x_left)/(y_low-y_high))*ratio)
ax2.set_extent([-180, 180, -90, -62], crs=ccrs.PlateCarree())
ax2.add_feature(cfeature.LAND, zorder=4, facecolor='white')
...
ax3.add_feature(cfeature.LAND, zorder=4, facecolor='white')
...
ax4.add_feature(cfeature.LAND, zorder=4, facecolor='white')
...
ax5.add_feature(cfeature.LAND, zorder=4, facecolor='white')
...
ax6.add_feature(cfeature.LAND, zorder=4, facecolor='white')
...
name_fig="waom10x4x2extend_shflim_S_0.25Q_bottom_TS_paper.png"
...
name_fig="waom10x4x2extend_shflim_S_0.25Q_MKExEKE_maps.png"
plt.savefig(fig_path + name_fig, dpi=300)
...
EKE_4km_interp = pyresample.kd_tree.resample_custom(w4vel_def,EKE_4km,w10vel_def,\
                                         radius_of_influence=30000,neighbours=4,weight_funcs=wf)
MKE_4kmB_interp = pyresample.kd_tree.resample_custom(w4vel_def,MKE_4kmB,w10vel_def,\
                                         radius_of_influence=30000,neighbours=4,weight_funcs=wf)
EKE_4kmB_interp = pyresample.kd_tree.resample_custom(w4vel_def,EKE_4kmB,w10vel_def,\
                                         radius_of_influence=30000,neighbours=4,weight_funcs=wf)
...
ax0.set_extent([-180, 180, -90, -65], crs=ccrs.PlateCarree())
ax0.add_feature(cfeature.LAND, zorder=3, facecolor='lightgrey')#ratio = .9
...
gl = ax00.gridlines(zorder=4,draw_labels=True, dms=False, x_inline=False, y_inline=False)
gl.rotate_labels = False
gl.ylabels_right = False
gl.xlines = True
gl.xlocator = mticker.FixedLocator(np.arange(-180,180,30))
...
gl.xformatter = LONGITUDE_FORMATTER
gl.yformatter = LATITUDE_FORMATTER
ax00.set_extent([-180, 180, -90, -65], crs=ccrs.PlateCarree())
ax00.add_feature(cfeature.LAND, zorder=3, facecolor='lightgrey')

ax1 = fig.add_subplot(423, projection=proj)
ct1=plt.pcolormesh(lon_rho_10km,lat_rho_10km,np.squeeze(temp_ann_10km[0,:,:])*mask_zice_10km*mask_shelf_10km, transform=ccrs.PlateCarree(), cmap=plt.cm.plasma, vmin=tmin, vmax=tmax)
#plt.title('A) Bottom temperature \n WAOM10')
...
# Add limits subregions:
plt.plot(-25*np.ones(len(np.arange(-76,-64,.1))),np.arange(-76,-64,.1), linestyle='dashed', color='k', transform=ccrs.PlateCarree(), linewidth=2)
plt.plot(-65*np.ones(len(np.arange(-67,-60.2,.1))),np.arange(-67,-60.2,.1), linestyle='dashed', color='k', transform=ccrs.PlateCarree(), linewidth=2)
plt.text(-52,-65,'FRIS',weight='bold', color='k', transform=ccrs.PlateCarree(), fontsize=11)
plt.plot(60*np.ones(len(np.arange(-67.5,-55.7,.1))),np.arange(-67.5,-55.7,.1), linestyle='dashed', color='k', transform=ccrs.PlateCarree(), linewidth=2)
plt.text(15,-68.5,'Maud Land',weight='bold', color='k', transform=ccrs.PlateCarree(), fontsize=11)
plt.plot(160*np.ones(len(np.arange(-70,-61,.1))),np.arange(-70,-61,.1), linestyle='dashed', color='k', transform=ccrs.PlateCarree(), linewidth=2)
plt.text(155,-64,'East Ant.',weight='bold', color='k', transform=ccrs.PlateCarree(), fontsize=11)
plt.plot(-140*np.ones(len(np.arange(-75.5,-55,.1))),np.arange(-75.5,-55,.1), linestyle='dashed', color='k', transform=ccrs.PlateCarree(), linewidth=2)
plt.text(-150,-63,'Ross IS',weight='bold', color='k', transform=ccrs.PlateCarree(), fontsize=11)
plt.text(-115,-62.5,'West Ant.',weight='bold', color='k', transform=ccrs.PlateCarree(), fontsize=11)
...
cs1=plt.pcolormesh(lon_rho_10km,lat_rho_10km,np.squeeze(salt_ann_10km[0,:,:])*mask_zice_10km*mask_shelf_10km, transform=ccrs.PlateCarree(), cmap=plt.cm.plasma, vmin=smin, vmax=smax)
#plt.title('B) Bottom salinity \n WAOM10')
...
ct2=plt.pcolormesh(lon_rho_10km,lat_rho_10km,(bot_temp_ann_4km_interp-np.squeeze(temp_ann_10km[0,:,:]))*mask_zice_10km*mask_shelf_10km, transform=ccrs.PlateCarree(), cmap=plt.cm.seismic, vmin=Atmin, vmax=Atmax)
...
cs2=plt.pcolormesh(lon_rho_10km,lat_rho_10km,(bot_salt_ann_4km_interp-np.squeeze(salt_ann_10km[0,:,:]))*mask_zice_10km*mask_shelf_10km, transform=ccrs.PlateCarree(), cmap=plt.cm.seismic, vmin=Asmin, vmax=Asmax)
...
gl.xformatter = LONGITUDE_FORMATTER
gl.yformatter = LATITUDE_FORMATTER
ax4.set_extent([-180, 180, -90, -65], crs=ccrs.PlateCarree())
ax4.add_feature(cfeature.LAND, zorder=3, facecolor='lightgrey')

ax5 = fig.add_subplot(427, projection=proj)
ct2=plt.pcolormesh(lon_rho_10km,lat_rho_10km,(bot_temp_ann_2km_interp-np.squeeze(temp_ann_10km[0,:,:]))*mask_zice_10km*mask_shelf_10km, transform=ccrs.PlateCarree(), cmap=plt.cm.seismic, vmin=Atmin, vmax=Atmax)
...
ax5.add_feature(cfeature.LAND, zorder=3, facecolor='lightgrey')

ax6 = fig.add_subplot(428, projection=proj)
cs2=plt.pcolormesh(lon_rho_10km,lat_rho_10km,(bot_salt_ann_2km_interp-np.squeeze(salt_ann_10km[0,:,:]))*mask_zice_10km*mask_shelf_10km, transform=ccrs.PlateCarree(), cmap=plt.cm.seismic, vmin=Asmin, vmax=Asmax)
...
ax6.add_feature(cfeature.LAND, zorder=3, facecolor='lightgrey')
...
name_fig="waom10x4x2extend_shflim_S_0.25Q_bottom_TS_paper_anomalies_shelf.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
#xlimit = np.arange(300,500,1) # -> using 10km
#ylimit = np.arange(100,300,1)
xlimit = np.arange(1500,2500,1) # using 2km
...
ax3 = fig.add_subplot(323, projection=proj)
ct2=plt.pcolormesh(lon_rho_10km,lat_rho_10km,(sfc_temp_ann_4km_interp-np.squeeze(temp_ann_10km[-1,:,:])), transform=ccrs.PlateCarree(), cmap=plt.cm.seismic, vmin=Atmin, vmax=Atmax)
plt.title('WAOM4')
ax3.gridlines() # draw_labels=True,linewidth=
x_left, x_right = ax3.get_xlim()
y_low, y_high = ax3.get_ylim()
...
ax4 = fig.add_subplot(324, projection=proj)
cs2=plt.pcolormesh(lon_rho_10km,lat_rho_10km,(sfc_salt_ann_4km_interp-np.squeeze(salt_ann_10km[-1,:,:])), transform=ccrs.PlateCarree(), cmap=plt.cm.seismic, vmin=Asmin, vmax=Asmax)
plt.title('WAOM4')
ax4.gridlines()
x_left, x_right = ax4.get_xlim()
y_low, y_high = ax4.get_ylim()
...
ax5 = fig.add_subplot(325, projection=proj)
ct2=plt.pcolormesh(lon_rho_10km,lat_rho_10km,(sfc_temp_ann_2km_interp-np.squeeze(temp_ann_10km[-1,:,:])), transform=ccrs.PlateCarree(), cmap=plt.cm.seismic, vmin=Atmin, vmax=Atmax)
plt.title('WAOM2')
ax5.gridlines() # draw_labels=True,linewidth=
x_left, x_right = ax5.get_xlim()
y_low, y_high = ax5.get_ylim()
...
ax6 = fig.add_subplot(326, projection=proj)
cs2=plt.pcolormesh(lon_rho_10km,lat_rho_10km,(sfc_salt_ann_2km_interp-np.squeeze(salt_ann_10km[-1,:,:])), transform=ccrs.PlateCarree(), cmap=plt.cm.seismic, vmin=Asmin, vmax=Asmax)
plt.title('WAOM2')
ax6.gridlines()
x_left, x_right = ax6.get_xlim()
y_low, y_high = ax6.get_ylim()
...
ax3 = fig.add_subplot(323, projection=proj)
ct2=plt.pcolormesh(lon_rho_10km,lat_rho_10km,(bot_temp_ann_4km_interp-np.squeeze(temp_ann_10km[0,:,:])), transform=ccrs.PlateCarree(), cmap=plt.cm.seismic, vmin=Atmin, vmax=Atmax)
plt.title('WAOM4')
ax3.gridlines() # draw_labels=True,linewidth=
x_left, x_right = ax3.get_xlim()
y_low, y_high = ax3.get_ylim()
...
ax4 = fig.add_subplot(324, projection=proj)
cs2=plt.pcolormesh(lon_rho_10km,lat_rho_10km,(bot_salt_ann_4km_interp-np.squeeze(salt_ann_10km[0,:,:])), transform=ccrs.PlateCarree(), cmap=plt.cm.seismic, vmin=Asmin, vmax=Asmax)
plt.title('WAOM4')
ax4.gridlines()
x_left, x_right = ax4.get_xlim()
y_low, y_high = ax4.get_ylim()
...
ax5 = fig.add_subplot(325, projection=proj)
ct2=plt.pcolormesh(lon_rho_10km,lat_rho_10km,(bot_temp_ann_2km_interp-np.squeeze(temp_ann_10km[0,:,:])), transform=ccrs.PlateCarree(), cmap=plt.cm.seismic, vmin=Atmin, vmax=Atmax)
plt.title('WAOM2')
ax5.gridlines() # draw_labels=True,linewidth=
x_left, x_right = ax5.get_xlim()
y_low, y_high = ax5.get_ylim()
...
ax6 = fig.add_subplot(326, projection=proj)
cs2=plt.pcolormesh(lon_rho_10km,lat_rho_10km,(bot_salt_ann_2km_interp-np.squeeze(salt_ann_10km[0,:,:])), transform=ccrs.PlateCarree(), cmap=plt.cm.seismic, vmin=Asmin, vmax=Asmax)
plt.title('WAOM2')
ax6.gridlines()
x_left, x_right = ax6.get_xlim()
y_low, y_high = ax6.get_ylim()
...
name_fig="waom10x4x2extend_shflim_S_0.25Q_MKE-EKE_RFIS_anomalies.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
name_fig="waom10x4x4cextend_shflim_S_0.25Q_MKE-EKE_EAnt_anomalies.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
name_fig="waom10x4x2extend_shflim_S_0.25Q_MKE-EKE_WAnt_anomalies.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
