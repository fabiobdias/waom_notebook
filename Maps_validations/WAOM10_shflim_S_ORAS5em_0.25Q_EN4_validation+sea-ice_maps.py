...
name_fig = 'waom10_shflim_S_ORAS5em_0.25QxEN4_surface_TS_annual_yr20.png'
...
name_fig ='waom10_shflim_S_ORAS5em_0.25QxEN4_bottom_TS_annual_yr20.png'
plt.savefig(fig_path + name_fig, dpi=300)
...
for mm in np.arange(0,12):
    ...
    name_fig='waom10_shflim_S_ORAS5em_0.25QxEN4_surface_TS_m=' + month + '_yr20.png'
...
for mm in np.arange(0,12):
    ...
    name_fig='waom10_shflim_ORAS5em_S_0.25QxEN4_bottom_TS_m=' + month + '_yr20.png'
    plt.savefig(fig_path + name_fig, dpi=300)
