...
mask_shelf_2km = ma.masked_where(h_2km > 2000, np.ones(zice_2km.shape))
...
plt.title('D) WAOM2')
cy=plt.pcolormesh(lon_rho_2km,lat_rho_2km,np.nanmean(m_2km, axis=0)*86400*365.25, transform=ccrs.PlateCarree(), cmap=plt.cm.seismic, vmin=Vmin, vmax=Vmax)#, norm=norm) 
...
name_fig="Susheel_waom10x4x2extend_shflim_S_0.25Q_melt_rates_maps_annual_yr20.png"
...
name_fig="Susheel_waom10x4x2extend_shflim_S_0.25Q_melt_rates_maps_annual_yr20_FRIS.png"
