...
# load ROMS avg output
ds = xr.open_dataset("/scratch/project_2000339/boeiradi/waom2extend_shflim_S_0.25Q/output_01-05yr/ocean_avg_0004.nc")
...
salt_sfc = ds.salt.isel(s_rho=-1).mean(axis=0)
temp_sfc = np.nan_to_num(temp_sfc)
salt_sfc = np.nan_to_num(salt_sfc)

temp_bot = ds.temp.isel(s_rho=0).mean(axis=0)
salt_bot = ds.salt.isel(s_rho=0).mean(axis=0)
temp_bot = np.nan_to_num(temp_bot)
salt_bot = np.nan_to_num(salt_bot)
...
#    ds = xr.open_dataset('//scratch/project_2000789/boeiradi/waom2_shflim_S_ORAS5em_0.25Q/output_10yr/ocean_avg_00' + mm + '.nc')
...
ct=plt.pcolormesh(lon_rho,lat_rho,temp_sfc, transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=tmin, vmax=tmax, shading='flat')
#ct=plt.imshow(temp_sfc, extent=[lon_rho.min(), lon_rho.max(), lat_rho.min(), lat_rho.max()], transform=ccrs.PlateCarree(),  vmin=tmin, vmax=tmax, cmap=plt.cm.inferno)#, norm=normT_sfc)
cbart =fig.colorbar(ct)# , extend='both')
plt.title('Surface temperature - WAOM 2km')
...
ci=plt.contour(ice_xgrid, ice_ygrid,np.squeeze(ice_mm[8,:,:]), levels=[.75],colors='gray', transform=ccrs.Stereographic(**kw)) #
ci=plt.contour(ice_xgrid, ice_ygrid,np.squeeze(ice_mm[2,:,:]), levels=[.75],colors='white', transform=ccrs.Stereographic(**kw)) #
cs=plt.pcolormesh(lon_rho,lat_rho,salt_sfc, transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=smin, vmax=smax, shading='flat')
cbars =fig.colorbar(cs)# , extend='both')
plt.title('Surface salinity - WAOM 2km')
...
ct2=plt.pcolormesh(EN_lon[:,:22],EN_lat[:,:22],np.transpose(EN_temp_sfc[:22,:]), transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=tmin, vmax=tmax, shading='flat')
...
cs2=plt.pcolormesh(EN_lon[:,:22],EN_lat[:,:22],np.transpose(EN_salt_sfc[:22,:]), transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=smin, vmax=smax, shading='flat')
...
#plt.tight_layout()
name_fig = 'waom2extend_shflim_S_0.25QxEN4_surface_TS_annual_yr19.png'
...
ax1 = fig.add_subplot(221, projection=proj)
ct=plt.pcolormesh(lon_rho,lat_rho,temp_bot, transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=tmin, vmax=tmax, shading='flat')
cbart =fig.colorbar(ct)# , extend='both')
...
ax2 = fig.add_subplot(222, projection=proj)
cs=plt.pcolormesh(lon_rho,lat_rho,salt_bot, transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=smin, vmax=smax, shading='flat')
cbars =fig.colorbar(cs)# , extend='both')
plt.title('Bottom salinity - WAOM 2km')
ax2.coastlines(resolution='110m')
ax2.gridlines()
lonlat_labels(ax2)
ax2.set_extent([-180, 180, -90, -60], crs=ccrs.PlateCarree())
...
ax3 = fig.add_subplot(223, projection=proj)
ct2=plt.pcolormesh(EN_lon[:,:22],EN_lat[:,:22],np.transpose(EN_temp_mbot[:22,:]), transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=tmin, vmax=tmax, shading='flat')
cbart =fig.colorbar(ct2)# , extend='both')
...
ax4 = fig.add_subplot(224, projection=proj)
cs2=plt.pcolormesh(EN_lon[:,:22],EN_lat[:,:22],np.transpose(EN_salt_mbot[:22,:]), transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=smin, vmax=smax, shading='flat')
cbars =fig.colorbar(cs2)# , extend='both')
...
#plt.tight_layout()
name_fig ='waom2extend_shflim_S_0.25QxEN4_bottom_TS_annual_yr19.png'
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
#    ct=plt.pcolormesh(lon_rho,lat_rho,temp_sfc_mm, transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=tmin, vmax=tmax)
#    cbart =fig.colorbar(ct)# , extend='both')
...
#    ax2 = fig.add_subplot(222, projection=proj)
#    ci=plt.contour(ice_xgrid, ice_ygrid,np.squeeze(ice_mm[mm,:,:]), levels=[.75],colors='dimgray', transform=ccrs.Stereographic(**kw))
#    cs=plt.pcolormesh(lon_rho,lat_rho,salt_sfc_mm, transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=smin, vmax=smax)
#    cbars =fig.colorbar(cs)# , extend='both')
...
#
#    ax3 = fig.add_subplot(223, projection=proj)
#    ct2=plt.pcolormesh(EN_lon[:,:22],EN_lat[:,:22],np.transpose(EN_temp_sfc_mm[:22,:]), transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=tmin, vmax=tmax)
#    cbart =fig.colorbar(ct2)# , extend='both')
...
#
#    ax4 = fig.add_subplot(224, projection=proj)
#    cs2=plt.pcolormesh(EN_lon[:,:22],EN_lat[:,:22],np.transpose(EN_salt_sfc_mm[:22,:]), transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=smin, vmax=smax)#, vmin=32, vmax=35)
#    cbars =fig.colorbar(cs2)# , extend='both')
#    plt.title('SST EN4, m=' + str(mm+1))
#    ax4.gridlines()
#    ax4.coastlines(resolution='110m')
...
#    month=str(mm+1)
#
#    name_fig='waom2extend_shflim_S_0.25QxEN4_surface_TS_m=' + month + '_yr15.png'
...
#    ax1 = fig.add_subplot(221, projection=proj)
#    ci=plt.contour(ice_xgrid, ice_ygrid,np.squeeze(ice_mm[mm,:,:]), levels=[.75],colors='dimgray', transform=ccrs.Stereographic(**kw))
#    ct=plt.pcolormesh(lon_rho,lat_rho,temp_bot_mm, transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=tmin, vmax=tmax)
#    cbart =fig.colorbar(ct)# , extend='both')
...
#    ax2 = fig.add_subplot(222, projection=proj)
#    ci=plt.contour(ice_xgrid, ice_ygrid,np.squeeze(ice_mm[mm,:,:]), levels=[.75],colors='dimgray', transform=ccrs.Stereographic(**kw))
#    cs=plt.pcolormesh(lon_rho,lat_rho,salt_bot_mm, transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=smin, vmax=smax)
#    cbars =fig.colorbar(cs)# , extend='both')
...
#
#    ax3 = fig.add_subplot(223, projection=proj)
#    ct2=plt.pcolormesh(EN_lon[:,:22],EN_lat[:,:22],np.transpose(EN_temp_bot_mm[:22,:]), transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=tmin, vmax=tmax)
#    cbart =fig.colorbar(ct2)# , extend='both')
...
#
#    ax4 = fig.add_subplot(224, projection=proj)
#    cs2=plt.pcolormesh(EN_lon[:,:22],EN_lat[:,:22],np.transpose(EN_salt_bot_mm[:22,:]), transform=ccrs.PlateCarree(), cmap=plt.cm.inferno, vmin=smin, vmax=smax)#, vmin=32, vmax=35)
#    cbars =fig.colorbar(cs2)# , extend='both')
#    plt.title('Temperature EN4, m=' + str(mm+1))
#    ax4.gridlines()
#    ax4.coastlines(resolution='110m')
...
#
#    
#    name_fig='waom2extend_shflim_S_0.25QxEN4_bottom_TS_m=' + month + '_yr15.png'
#    plt.savefig(fig_path + name_fig, dpi=300)
