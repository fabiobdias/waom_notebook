...
data_dir = os.path.join('/scratch','project_2000789','boeiradi','waom4_shflim_S_ORAS5em_0.25Q','output_10yr')
out_path = os.path.join(data_dir,'waom4_shflim_to10km_grd_monthly_avg.nc')
...
def interp_roms_4to10km(): # 'wed',0,0

    # load ROMS avg output
    count = 0
    for mm in ['01','02','03','04','05','06','07','08','09','10','11','12']:
        hr_ds = xr.open_dataset("/scratch/project_2000789/boeiradi/waom4_shflim_S_ORAS5em_0.25Q/output_10yr/ocean_avg_00" + mm + ".nc")
...
hr_grd = xr.open_dataset("/scratch/project_2000339/boeiradi/waom4_frc/waom4_grd.nc")
lr_grd = xr.open_dataset("/scratch/project_2000339/boeiradi/waom10_frc/waom10_grd.nc")
#lr_ini = xr.open_dataset("/scratch/project_2000339/boeiradi/waom10_frc/waom10_ini.nc")
lr_avg =  xr.open_dataset("/scratch/project_2000339/boeiradi/waom10_shflim_S_0.25Q/output_01-20yr/ocean_avg_0001.nc") #/scratch/project_2000339/boeiradi/waom10_shflim_S/output_11-15yr/ocean_avg_0003.nc")
