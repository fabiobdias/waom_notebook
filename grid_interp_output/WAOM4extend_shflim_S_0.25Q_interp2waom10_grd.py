...
data_dir = os.path.join('/scratch','project_2000789','boeiradi','waom4extend_shflim_S_0.25Q','output_yr10_diag')
out_path = os.path.join(data_dir,'waom4extend_to10km_grd_monthly_avg.nc')
...
def interp_roms_4to10km(): # 'wed',0,0
    ...
    for mm in ['01','02','03','04','05','06','07','08','09','10','11','12']:
        hr_ds = xr.open_dataset("/scratch/project_2000789/boeiradi/waom4extend_shflim_S_0.25Q/output_yr10_diag/ocean_avg_00" + mm + ".nc")
...
hr_grd = xr.open_dataset("/scratch/project_2000339/boeiradi/waom4_frc/waom4extend_grd.nc")
