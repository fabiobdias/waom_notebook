...
## load section vars:
#bar = '/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM4extend_shflim_S_sec_bar_5days_annual.nc'
...
#
#vin = '/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM4extend_shflim_S_sec_vin_5days_annual.nc'
#print(vin)
...
#
#sha = '/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM4extend_shflim_S_sec_sha_5days_annual.nc'
##sec = iris.load('/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM4extend_shflim_S_ORAS5em_0.25Q_sec_sha_5days_annual.nc')
...
for ee in np.arange(0,20):
    ...
    bar = '/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM4extend_shflim_S_sec_bar_5days_mm' + mm + '.nc'
    ...
    sha = '/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM4extend_shflim_S_sec_sha_5days_mm' + mm + '.nc'
    ...
    vin = '/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM4extend_shflim_S_sec_vin_5days_mm' + mm + '.nc'
    ...
    pry = '/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM4extend_shflim_S_sec_pry_5days_mm' + mm + '.nc'
    ...
    dar = '/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM4extend_shflim_S_sec_dar_5days_mm' + mm + '.nc'
    ...
    mer = '/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM4extend_shflim_S_sec_mer_5days_mm' + mm + '.nc'
    ...
    name_fig="waom4extend_shflim_S_0.25Q_EastAntarct_sections_TSdiag_yr20_ee=" + date_storms[ee] + ".png"
