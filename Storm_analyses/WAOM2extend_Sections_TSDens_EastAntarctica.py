...
def read_section_roms(sec_name,ind_ij, ind_len):
    ...
    monthly_ind_ini = [0, 7, 13, 18, 25, 31, 36, 43, 49, 54, 61, 67]
    monthly_ind_end = [6, 12, 17, 24, 30, 35, 42, 48, 53, 60, 66, 71]
...
for ee in np.arange(0,19):
    ...
    plt.contour(section_lat_dar_mask, np.squeeze(section_z_dar_mask[ee,:,:]), np.squeeze(section_rho_dar[ee,:,:]), colors='white', levels=[36.9],linewidth=2)
...
#    plt.colorbar(cs, extend='both')
    ...
    plt.contour(section_lat_pry_mask, np.squeeze(section_z_pry_mask[ee,:,:]), np.squeeze(section_rho_pry[ee,:,:]), colors='white', levels=[36.9],linewidth=2)
#    plt.colorbar(ct, extend='both')
    plt.xlim([-70,-61])
    plt.ylim([-600,0])
...
#    plt.colorbar(cs, extend='both')
    ...
    plt.contour(section_lat_bar_mask, np.squeeze(section_z_bar_mask[ee,:,:]), np.squeeze(section_rho_bar[ee,:,:]), colors='white', levels=[36.9],linewidth=2)
#    plt.colorbar(ct, extend='both')
    plt.xlim([-70,-61])
    plt.ylim([-600,0])
...
#    plt.colorbar(cs, extend='both')
    ...
    plt.contour(section_lat_sha_mask, np.squeeze(section_z_sha_mask[ee,:,:]), np.squeeze(section_rho_sha[ee,:,:]), colors='white', levels=[36.9],linewidth=2)
#    plt.colorbar(ct, extend='both')
    plt.xlim([-66,-61.5])
    plt.ylim([-600,0])
...
#    plt.colorbar(cs, extend='both')
    ...
    plt.contour(section_lat_vin_mask, np.squeeze(section_z_vin_mask[ee,:,:]), np.squeeze(section_rho_vin[ee,:,:]), colors='white', levels=[36.9],linewidth=2)
#    plt.colorbar(ct, extend='both')
    plt.xlim([-66,-61.8])
    plt.ylim([-600,0])
...
#    plt.colorbar(cs, extend='both')
    ...
    plt.contour(section_lat_mer_mask, np.squeeze(section_z_mer_mask[ee,:,:]), np.squeeze(section_rho_mer[ee,:,:]), colors='white', levels=[36.9],linewidth=2)
#    plt.colorbar(ct, extend='both')
    plt.xlim([-70,-63.7])
    plt.ylim([-600,0])
...
#    plt.colorbar(cs, extend='both')
    ...
    name_fig="waom2extend_All_EastAntarct_sections_event=" + date_storms[ee] + ".png"
