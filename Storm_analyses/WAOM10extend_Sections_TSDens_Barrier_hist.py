...
# load ROMS avg output
    ...
    for mm in ['01','02','03','04','05','06','07','08','09','10','11','12']:
        ds = xr.open_dataset("/scratch/project_2000789/boeiradi/waom10extend_shflim_S_0.25Q/output_21yr/ocean_his_00" + mm + ".nc")
...
#    plt.ylabel('Depth (m)')
    ...
    name_fig="waom10extend_BarrierPolynya_sections_event=" + date_storms[ee] + "_hist.png"
