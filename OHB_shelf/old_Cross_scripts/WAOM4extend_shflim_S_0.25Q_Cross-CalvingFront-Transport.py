...
temp_along_contour_xr.to_netcdf(files_path + 'WAOM4_temp_CalvingFront', mode='w', format="NETCDF4")
Tf_heat_trans_across_contour_xr.to_netcdf(files_path + 'WAOM4_Tf_heat_transp_CalvingFront', mode='w', format="NETCDF4")
heat_trans_across_contour_xr.to_netcdf(files_path + 'WAOM4_heat_transp_CalvingFront', mode='w', format="NETCDF4")
z_rho_across_contour_xr.to_netcdf(files_path + 'WAOM4_Zrho_CalvingFront', mode='w', format="NETCDF4")
...
plt.grid()
plt.legend()
name_fig='WAOM4_Cross-CalvingFront_transport_vint_raw.png'
...
plt.grid()
plt.legend()
name_fig='WAOM4_Cross-CalvingFront_transport_z-levels_raw.png'
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
plt.grid()
plt.legend()
name_fig='WAOM4_Cross-CalvingFront_transport_vint-smoothed_raw.png'
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
name_fig='WAOM4_Cross-CalvingFront_transport_section_raw.png'
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
lon_along_contour
lon_along_contour.to_netcdf(files_path + 'WAOM4_lon_along_CalvingFront', mode='w', format="NETCDF4")

lat_along_contour
lat_along_contour.to_netcdf(files_path + 'WAOM4_lat_along_CalvingFront', mode='w', format="NETCDF4")
## distance
...
distance_along_contour_xr.to_netcdf(files_path + 'WAOM4_dist_along_CalvingFront', mode='w', format="NETCDF4")
# distance indices
...
distance_indices_xr.to_netcdf(files_path + 'WAOM4_dist_indices_CalvingFront', mode='w', format="NETCDF4")
...
axes[1].grid()
name_fig='WAOM4_Cross-CalvingFront_CumTransport_vint.png'
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
name_fig='WAOM4_Cross-CalvingFront_CumTransport_smoothed_vint.png'
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
