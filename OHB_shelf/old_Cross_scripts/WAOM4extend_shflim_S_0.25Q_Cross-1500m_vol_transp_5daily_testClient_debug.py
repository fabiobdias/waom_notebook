...
#client = Client()#n_workers=96,threads_per_worker=1, memory_limit=0, silence_logs=logging.ERROR)
#client

# load ice draft to create masks
di = xr.open_dataset('/g/data/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom4extend_shflim_S_0.25Q/output_yr10_diag/ocean_avg_0001.nc')
...
print('... Finished reading ice draft')
...
print('... Finished obtaining the isobath contour')
...
print('... Finished obtaining lat/lon and masking south/north of contour')
...
print('... Finished creating masks for u/v transports')
...
print('... Finished interpolating mask to u/v grids')
...
print('... Finished arranging mask for u/v transports into the contour')
        
# using xr.open_mfdataset

vars2drop = ["ubar","vbar","w","Hsbl","Hbbl","swrad"]

ds = xr.open_mfdataset(paths="/g/data/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom4extend_shflim_S_0.25Q/output_yr10_diag/ocean_avg_00*.nc" , chunks={'eta_rho': '200MB'}, parallel=True, drop_variables=vars2drop, decode_times=False) # , concat_dim="ocean_time"
...
print('... Finished reading ocean_avg vars')
...
print('... Finished setting function to extract transport across contour')
...
print('... Done until "extract__transp_across_contour"')

# 1. vol transp
vol_trans_across_contour = extract_transp_across_contour(Huon_xr, Hvom_xr)

print('... Finished "extract__transp_across_contour"')
# save to netcdf file:
...
vol_trans_across_contour_xr.to_netcdf(files_path + 'WAOM4_vol_trans_1500m_5daily_test_v2', mode='w', format="NETCDF4")
