...
# Description:
#     this script obtain and save the 2000m isobath contour variables, which is used for the 
...
if __name__== '__main__':
    ...
    salt_along_contour_xr.to_netcdf(files_path + 'WAOM10_salt_2000m_daily', mode='w', format="NETCDF4")
