...
# extract variables:
# 1. temp
heat_trans_across_contour = extract_transp_across_contour(heat_xtransp, heat_ytransp)
...
heat_trans_across_contour_xr.to_netcdf(files_path + 'WAOM4_notides_heat_trans_1500m_daily', mode='w', format="NETCDF4")
