...
# load contour generated from WAOM4_Extract_1500m_contour.ipynb
    ...
    print(len(contour_index_array), lon_along_contour.shape, lat_along_contour.shape, distance_along_contour.shape)
    ...
    lon_along_contour_xr.to_netcdf(files_path + 'WAOM4_lon_along_1500m_v2', mode='w', format="NETCDF4")

    #lat_along_contour
    lat_along_contour_xr = xr.DataArray(lat_along_contour, coords = coordinatesD, dims = ['contour_index_array'])
    lat_along_contour_xr.to_netcdf(files_path + 'WAOM4_lat_along_1500m_v2', mode='w', format="NETCDF4")

    ## distance
    distance_along_contour_xr = xr.DataArray(distance_along_contour, coords = coordinatesD, dims = ['contour_index_array'])
    distance_along_contour_xr.to_netcdf(files_path + 'WAOM4_dist_along_1500m_v2', mode='w', format="NETCDF4")
    ...
    distance_indices_xr.to_netcdf(files_path + 'WAOM4_dist_indices_1500m_v2', mode='w', format="NETCDF4")
