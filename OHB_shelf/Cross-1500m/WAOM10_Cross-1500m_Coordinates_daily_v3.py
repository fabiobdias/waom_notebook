...
# load contour generated from WAOM10_Extract_1500m_contour.ipynb
    ...
    lon_along_contour_xr.to_netcdf(files_path + 'WAOM10_lon_along_1500m_v3', mode='w', format="NETCDF4")
    print('exported lon_along_contour')

    #lat_along_contour
    lat_along_contour_xr = xr.DataArray(lat_along_contour, coords = coordinatesD, dims = ['contour_index_array'])
    lat_along_contour_xr.to_netcdf(files_path + 'WAOM10_lat_along_1500m_v3', mode='w', format="NETCDF4")
    print('exported lat_along_contour')
    
    ## distance
    distance_along_contour_xr = xr.DataArray(distance_along_contour, coords = coordinatesD, dims = ['contour_index_array'])
    distance_along_contour_xr.to_netcdf(files_path + 'WAOM10_dist_along_1500m_v3', mode='w', format="NETCDF4")
    print('exported dist_along_contour')
    ...
    distance_indices_xr.to_netcdf(files_path + 'WAOM10_dist_indices_1500m_v3', mode='w', format="NETCDF4") 
    print('exported dist_indices')
