...
if __name__== '__main__':
    ...
    # extract variables:
    # 1. heat transp
    heat_trans_across_contour = extract_transp_across_contour(HuonT_xr*rho0*Cp, HvomT_xr*rho0*Cp)
    ...
    heat_trans_across_contour_xr.to_netcdf(files_path + 'WAOM4_notides_heat_trans_1500m_5daily', mode='w', format="NETCDF4")
