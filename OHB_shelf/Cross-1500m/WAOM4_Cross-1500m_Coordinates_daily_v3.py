...
# load contour generated from WAOM4_Extract_1500m_contour.ipynb
    ...
    lon_along_contour_xr.to_netcdf(files_path + 'WAOM4_lon_along_1500m_v3', mode='w', format="NETCDF4")
    ...
    lat_along_contour_xr.to_netcdf(files_path + 'WAOM4_lat_along_1500m_v3', mode='w', format="NETCDF4")
    ...
    distance_along_contour_xr.to_netcdf(files_path + 'WAOM4_dist_along_1500m_v3', mode='w', format="NETCDF4")
    ...
    distance_indices_xr.to_netcdf(files_path + 'WAOM4_dist_indices_1500m_v3', mode='w', format="NETCDF4") 
