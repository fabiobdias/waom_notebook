...
if __name__== '__main__':
    ...
    contour_masked_above.dump(files_path + 'WAOM2_contour_masked_above_1500m')
...
#    Huon = ds.variables["Huon"]
    ...
    temp_along_contour_xr.to_netcdf(files_path + 'WAOM2_temp_1500m_5daily', mode='w', format="NETCDF4")
