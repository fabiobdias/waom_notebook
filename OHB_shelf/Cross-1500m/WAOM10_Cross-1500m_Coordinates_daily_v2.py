...
# load contour generated from WAOM10_Extract_1500m_contour.ipynb
    ...
    lon_along_contour_xr.to_netcdf(files_path + 'WAOM10_lon_along_1500m_v2', mode='w', format="NETCDF4")
    ...
    lat_along_contour_xr.to_netcdf(files_path + 'WAOM10_lat_along_1500m_v2', mode='w', format="NETCDF4")
    ...
    distance_along_contour_xr.to_netcdf(files_path + 'WAOM10_dist_along_1500m_v2', mode='w', format="NETCDF4")
    ...
    distance_indices_xr.to_netcdf(files_path + 'WAOM10_dist_indices_1500m_v2', mode='w', format="NETCDF4") 
