...
# load contour generated from WAOM4_Extract_1500m_contour.ipynb
    ...
    contour_masked_above.dump(files_path + 'WAOM4_contour_masked_above_1500m')
    ...
    temp_along_contour_xr.to_netcdf(files_path + 'WAOM4_temp_1500m_daily_v2', mode='w', format="NETCDF4")
