...
# load contour generated from WAOM10_Extract_1500m_contour.ipynb
    ...
    vol_trans_across_contour_xr.to_netcdf(files_path + 'WAOM10_vol_trans_1500m_daily_v2', mode='w', format="NETCDF4")
#    vol_trans_across_contour_xr.to_netcdf(files_path + 'WAOM10_vol_trans_1500m_daily_testNewCode', mode='w', format="NETCDF4") # previously saved as testNewCode to compare with testOldCode.
