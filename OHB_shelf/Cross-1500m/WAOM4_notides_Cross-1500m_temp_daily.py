...
if __name__== '__main__':
    ...
    contour_masked_above.dump(files_path + 'WAOM4_notides_contour_masked_above_1500m')
    ...
    temp_along_contour_xr.to_netcdf(files_path + 'WAOM4_notides_temp_1500m_5daily', mode='w', format="NETCDF4")
