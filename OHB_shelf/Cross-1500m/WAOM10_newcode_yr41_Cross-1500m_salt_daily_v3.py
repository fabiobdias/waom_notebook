...
# load contour generated from WAOM10_Extract_1500m_contour.ipynb
    ...
    ds = xr.open_mfdataset(paths="/scratch/gi0/fbd581/waom10extend_testcode/output_41yr_diag_daily/ocean_avg_0*.nc" , chunks={'eta_rho': '200MB'}, parallel=True, drop_variables=vars2drop, decode_times=False)
    ...
    salt_along_contour_xr.to_netcdf(files_path + 'WAOM10_newcode_yr41_salt_1500m_daily_v3', mode='w', format="NETCDF4")
