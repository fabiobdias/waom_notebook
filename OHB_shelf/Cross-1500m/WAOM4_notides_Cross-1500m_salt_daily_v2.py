...
if __name__== '__main__':
    ...
    di = xr.open_dataset('/g/data/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom4extend_shflim_S_0.25Q/output_yr10_notides_diag/ocean_avg_0001.nc')
...
# load contour generated from WAOM4_Extract_1500m_contour.ipynb
    ...
    ds = xr.open_mfdataset(paths="/g/data/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom4extend_shflim_S_0.25Q/output_yr10_notides_diag_daily/ocean_avg_00*.nc" , chunks={'eta_rho': '200MB'}, parallel=True, drop_variables=vars2drop, decode_times=False) # , concat_dim="ocean_time"
    ...
    salt_along_contour_xr = xr.DataArray(salt_along_contour, coords = coordinatesC, dims = ['ocean_time','s_rho','contour_index_array'])
    files_path = '/g/data/hh5/tmp/access-om/fbd581/ROMS/postprocessing/cross_contour_tmp/'
    salt_along_contour_xr.to_netcdf(files_path + 'WAOM4_notides_salt_1500m_daily_v2', mode='w', format="NETCDF4")
