...
if __name__== '__main__':
    ...
    di = xr.open_dataset('/scratch/gi0/fbd581/waom10extend_shflim_S_0.25Q/output_20-22yr_diag_daily/ocean_avg_0001.nc')
...
# load contour generated from WAOM10_Extract_1500m_contour.ipynb
    ...
    ds = xr.open_mfdataset(paths="/scratch/gi0/fbd581/waom10extend_shflim_S_0.25Q/output_20-22yr_diag_daily/ocean_avg_0*.nc" , chunks={'eta_rho': '200MB'}, parallel=True, drop_variables=vars2drop, decode_times=False)
#            /g/data/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom10extend_shflim_S_0.25Q/output_20yr_diag_daily/ocean_avg_00*.nc" , chunks={'eta_rho': '200MB'}, parallel=True, drop_variables=vars2drop, decode_times=False)
    ...
    months=np.arange(0,1095)*(1/30.41667)
    ...
    heat_trans_across_contour_xr.to_netcdf(files_path + 'WAOM10_heat_trans_1500m_daily_v4_3yrs', mode='w', format="NETCDF4")
