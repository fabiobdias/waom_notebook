...
# load contour generated from WAOM10_Extract_CF_contour.ipynb
    ...
    lon_along_contour_xr.to_netcdf(files_path + 'WAOM10_lon_along_CF_v3', mode='w', format="NETCDF4")

    #lat_along_contour
    lat_along_contour_xr = xr.DataArray(lat_along_contour, coords = coordinatesD, dims = ['contour_index_array'])
    lat_along_contour_xr.to_netcdf(files_path + 'WAOM10_lat_along_CF_v3', mode='w', format="NETCDF4")

    ## distance
    distance_along_contour_xr = xr.DataArray(distance_along_contour, coords = coordinatesD, dims = ['contour_index_array'])
    distance_along_contour_xr.to_netcdf(files_path + 'WAOM10_dist_along_CF_v3', mode='w', format="NETCDF4")
    ...
    distance_indices_xr.to_netcdf(files_path + 'WAOM10_dist_indices_CF_v3', mode='w', format="NETCDF4")
