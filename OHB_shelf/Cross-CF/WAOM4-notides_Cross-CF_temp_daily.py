...
if __name__== '__main__':
    ...
    count = 398 # contour 211 for ice draft (-.01)
    x_contour = []
    y_contour = []
    ...
    name_fig="/g/data/hh5/tmp/access-om/fbd581/ROMS/postprocessing/figs/Contour_isobath/waom4extend_ice_draft=0m_contour_cc=398_final.png"
    ...
    temp_along_contour_xr.to_netcdf(files_path + 'WAOM4_notides_temp_CF_daily', mode='w', format="NETCDF4")
