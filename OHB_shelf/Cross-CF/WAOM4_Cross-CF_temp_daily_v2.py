...
if __name__== '__main__':
    ...
    # creating the contour, such as a isobath, and extracting the coordinates using matplotlis Path class
    ...
    # Now remove the indices (start from the end so the indices dont shift)
    ...
    temp_along_contour_xr.to_netcdf(files_path + 'WAOM4_temp_CF_daily_v2', mode='w', format="NETCDF4")
