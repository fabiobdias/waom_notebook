...
if __name__== '__main__':
    ...
    lonlat_bin_midpts[50:60] = np.arange(lon_bins[49],lon_bins[60],.07)
    ...
    files_path = '/g/data/hh5/tmp/access-om/fbd581/ROMS/postprocessing/cross_contour_tmp/'
    temp_hdiff_int_xr.to_netcdf(files_path + 'WAOM10_OHB_lonlatbins-v2_temp_hdiff_vint_daily_iceshelf', mode='w', format="NETCDF4")
