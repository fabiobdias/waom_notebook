...
if __name__== '__main__':
    ...
    for ll in np.arange(0,len(mask_LonBins)):
        ...
        for mm in np.arange(0,tlen):
            print('debuging, print mm, ll, temp_vadv.shape, dz.shape =',
                    mm, ll, temp_vadv.shape, dz.shape)
        # - multplying by dz:
    ...
    files_path = '/g/data/hh5/tmp/access-om/fbd581/ROMS/postprocessing/cross_contour_tmp/'
    temp_vadv_int_xr.to_netcdf(files_path + 'WAOM2_OHB_lonbins_temp_vadv_vint_5daily_iceshelf', mode='w', format="NETCDF4")
