...
if __name__== '__main__':
    ...
    contour_masked_above = np.load(files_path + 'WAOM4_notides_contour_masked_above_1500m', allow_pickle=True)
    contour_masked_above = np.load(files_path + 'WAOM4_notides_contour_masked_above_1500m', allow_pickle=True)
    plt.pcolormesh(ma.masked_where(contour_masked_above == -1000, temp.isel(ocean_time=0, s_rho=0)))
    plt.colorbar()
    
    ds = xr.open_mfdataset(paths="/g/data/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom4extend_shflim_S_0.25Q/output_yr10_notides_diag_daily/ocean_his_00*.nc" , chunks={'eta_rho': '200MB'}, parallel=bool, decode_times=False) #, chuncks="auto", concat_dim="ocean_time"
    ...
    ds = xr.open_dataset('/g/data/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom4extend_shflim_S_0.25Q/output_yr9_notides/ocean_rst.nc')
    ...
    name_fig='WAOM4_notides_OHB_south1500m_temp_rate_vint+shflux_maps_annual.png'
    ...
    files_path = '/g/data/hh5/tmp/access-om/fbd581/ROMS/postprocessing/cross_contour_tmp/'
    temp_rate_int_xr.to_netcdf(files_path + 'WAOM4_notides_OHB_1500m_temp_rate_vint_5daily', mode='w', format="NETCDF4")
    shflux_int_xr.to_netcdf(files_path + 'WAOM4_notides_OHB_1500m_shflux_vint_5daily', mode='w', format="NETCDF4")
    ...
    name_fig='WAOM4_notides_OHB_south1500m_vint_annual.png'
    plt.savefig(fig_path + name_fig, dpi=300)
