...
if __name__== '__main__':
    ...
    ds = xr.open_mfdataset(paths="/g/data/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom4extend_shflim_S_0.25Q/output_yr10_iceshelf_diag_daily/ocean_dia_00*.nc" , chunks={'eta_rho': '200MB'}, parallel=bool, drop_variables=vars2drop, decode_times=False)
    ...
    files_path = '/g/data/hh5/tmp/access-om/fbd581/ROMS/postprocessing/cross_contour_tmp/'
    temp_vdiff_int_xr.to_netcdf(files_path + 'WAOM4_notides_OHB_lonbins_temp_vdiff_vint_daily_iceshelf', mode='w', format="NETCDF4")
