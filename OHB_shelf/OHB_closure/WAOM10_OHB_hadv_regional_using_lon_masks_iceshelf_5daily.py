...
if __name__== '__main__':
    ...
    for ll in np.arange(0,len(mask_LonBins)):
        ...
        # - multplying by dz:
            temp_hadv_dz = temp_hadv[mm,:]*dz[mm,:]*mask_outiceshelf
    ...
    files_path = '/g/data/hh5/tmp/access-om/fbd581/ROMS/postprocessing/cross_contour_tmp/'
    temp_hadv_int_xr.to_netcdf(files_path + 'WAOM10_OHB_lonbins_temp_hadv_vint_iceshelf_5daily', mode='w', format="NETCDF4")
