...
if __name__== '__main__':
    ...
    dm = xr.open_dataset('/g/data/hh5/tmp/access-om/fbd581/ROMS/postprocessing/cross_contour_tmp/WAOM10_masked_lonlatBins.nc')
    ...
    files_path = '/g/data/hh5/tmp/access-om/fbd581/ROMS/postprocessing/cross_contour_tmp/'
    temp_vdiff_int_xr.to_netcdf(files_path + 'WAOM10_OHB_lonlatbins_temp_vdiff_vint_daily_iceshelf', mode='w', format="NETCDF4")
