...
# using xr.open_mfdataset
    ...
    files_path = '/g/data/hh5/tmp/access-om/fbd581/ROMS/postprocessing/cross_contour_tmp/'
    melt_bins_shallow_xr.to_netcdf(files_path + 'WAOM4_OHB_lonlatbins-v2_melt_shallow_daily_v2.nc', mode='w', format="NETCDF4")
    melt_bins_deep_xr.to_netcdf(files_path + 'WAOM4_OHB_lonlatbins-v2_melt_deep_daily_v2.nc', mode='w', format="NETCDF4")
