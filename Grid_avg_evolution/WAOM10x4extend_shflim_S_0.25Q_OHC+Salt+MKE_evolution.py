...
#E4_ohc_hintn, E4_salt_hintn, E4_shflx_hintn, E4_sfwflx_hintn, E4_MKE_havg, E4_SST_havg, E4_SSS_havg, E4_ohc_hintn_shelf, E4_ohc_hintn_open, E4_salt_hintn_shelf, E4_salt_hintn_open = read_roms_ts_4km(path_ECCO2_4km)
...
plt.plot(np.arange(10,20)+1,E4_ohc_hintn,'--b',label='ECCO2 4km')
...
plt.plot(np.arange(10,20)+1,E4_salt_hintn,'--b',label='ECCO2 4km')
...
plt.plot(np.arange(10,20)+1,E4_MKE_havg,'--b',label='ECCO2 4km')
#l3 = plt.legend(bbox_to_anchor=(1.04,0.5), loc="center left", borderaxespad=0)
plt.ylabel('MKE (m$^{2}$ s$^{-2}$)')
plt.xlabel('years')

name_fig="waom10x4extend_shflim_S_0.25Q_OHC+Salt+MKE_evolution.png"
...
plt.plot(np.arange(10,20)+1,E4_SST_havg,'--b',label='ECCO2 4km')
#l3 = plt.legend(bbox_to_anchor=(1.04,0.5), loc="center left", borderaxespad=0)
l3 = plt.legend(loc="upper left", borderaxespad=0)
plt.ylabel('SST')
ax2 = fig.add_subplot(212)
plt.plot(np.arange(0,20)+1,E10_SSS_havg,'r',label='ECCO2 10km')
plt.plot(np.arange(10,20)+1,E4_SSS_havg,'--b',label='ECCO2 4km')
#l3 = plt.legend(bbox_to_anchor=(1.04,0.5), loc="center left", borderaxespad=0)
plt.ylabel('SSS')

name_fig="waom10x4extend_shflim_S_0.25Q_SST+SSS_evolution.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
