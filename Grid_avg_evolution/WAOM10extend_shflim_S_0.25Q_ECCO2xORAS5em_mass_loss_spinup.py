...
grd10_path = os.path.join(roms_dir,'waom10_frc','waom10extend_grd.nc')
#waom10_ORAS5_path = os.path.join(data_dir,'waom10_shflim_S_ORAS5em_0.25Q','output_01-20yr','ocean_avg_00??.nc')
waom10_ORAS5_path = os.path.join(scratch_dir,'waom10extend_shflim_S_0.25Q_ORAS5em','output_01-10yr','ocean_avg_00??.nc')
...
bmb10_ORAS5,ismr10_ORAS5,mask10_ORAS5 = total_bmb(avg10_ORAS5,grd10,vostock10,time2)
bmb10_ECCO2,ismr10_ECCO2,mask10_ECCO2 = total_bmb(avg10_ECCO2,grd10,vostock10,time1)


out_path = os.path.join(proj_dir,'waom10extend_mass_loss_spinup.png')
