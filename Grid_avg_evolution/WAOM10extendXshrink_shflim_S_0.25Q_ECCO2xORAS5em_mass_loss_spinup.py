...
grd10e_path = os.path.join(roms_dir,'waom10_frc','waom10extend_grd.nc')
grd10s_path = os.path.join(roms_dir,'waom10_frc','waom10extend_grd.nc')
#waom10_ORAS5_path = os.path.join(data_dir,'waom10_shflim_S_ORAS5em_0.25Q','output_01-20yr','ocean_avg_00??.nc')
waom10_ORAS5_path = os.path.join(scratch_dir,'waom10shrink_shflim_S_0.25Q_ORAS5em','output_01-20yr','ocean_avg_00??.nc')
waom10_ECCO2_path = os.path.join(scratch_dir,'waom10extend_shflim_S_0.25Q','output_01-20yr','ocean_avg_00??.nc')
vostock10e = [np.arange(200,260),np.arange(400,480)]
vostock10s = [np.arange(180,260),np.arange(400,480)]
time1 = slice('2007','2026')
time2 = slice('2007','2016')

avg10_ORAS5 = xr.open_mfdataset(waom10_ORAS5_path)
avg10_ECCO2 = xr.open_mfdataset(waom10_ECCO2_path)
grd10e = xr.open_dataset(grd10e_path)
grd10s = xr.open_dataset(grd10s_path)

bmb10_ORAS5,ismr10_ORAS5,mask10_ORAS5 = total_bmb(avg10_ORAS5,grd10e,vostock10e,time1)
bmb10_ECCO2,ismr10_ECCO2,mask10_ECCO2 = total_bmb(avg10_ECCO2,grd10s,vostock10s,time1)


out_path = os.path.join(proj_dir,'waom10extendXshrink_mass_loss_spinup.png')
