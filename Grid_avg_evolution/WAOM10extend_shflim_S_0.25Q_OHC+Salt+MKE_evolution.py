...
#    ds = xr.open_dataset("/g/data3/hh5/tmp/access-om/fbd581/ROMS/OUTPUT/waom10extend_shflim_S_0.25Q/output_01-20yr/ocean_avg_00" + yr + ".nc")
    ds = xr.open_dataset("/scratch/gh9/fbd581/ROMS/waom10extend_shflim_S_0.25Q/output_01-20yr/ocean_avg_00" + yr + ".nc")
...
plt.plot(np.arange(0,20)+1,ohc_hintn,'b',label='10km')
plt.text(8.,-4.75e9,'$\overline{Q}$ = ' +  str(np.around(shflx_hintn, decimals=0)) +' W m$^{-2}$')
l1 = plt.legend(bbox_to_anchor=(1.04,0.5), loc="center left", borderaxespad=0)
plt.ylabel('heat content (J)')
ax2 = fig.add_subplot(312)
plt.plot(np.arange(0,20)+1,salt_hintn,'r',label='10km')
plt.text(8.,-60150,'$\overline{FWF}$ = ' +  str(np.around(sfwflx_hintn, decimals=0)) +' m s$^{-1}$')
l2 = plt.legend(bbox_to_anchor=(1.04,0.5), loc="center left", borderaxespad=0)
plt.ylabel('salt content')
ax3 = fig.add_subplot(313)
plt.plot(np.arange(0,20)+1,MKE_havg,'k',label='10km')
l3 = plt.legend(bbox_to_anchor=(1.04,0.5), loc="center left", borderaxespad=0)
plt.ylabel('MKE (m$^{2}$ s$^{-2}$)')
plt.xlabel('years')

name_fig="waom10extend_shflim_S_0.25Q_OHC+Salt+MKE_evolution.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()

fig = plt.figure(figsize=(10,8))
ax1 = fig.add_subplot(211)
plt.plot(np.arange(0,20)+1,SST_havg,'b',label='10km')
l3 = plt.legend(bbox_to_anchor=(1.04,0.5), loc="center left", borderaxespad=0)
plt.ylabel('SST')
ax2 = fig.add_subplot(212)
plt.plot(np.arange(0,20)+1,SSS_havg,'r',label='10km')
l3 = plt.legend(bbox_to_anchor=(1.04,0.5), loc="center left", borderaxespad=0)
plt.ylabel('SSS')

name_fig="waom10extend_shflim_S_0.25Q_SST+SSS_evolution.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
...
name_fig="waom10extend_shflim_S_0.25Q_OHC+Salt_subregions_evolution.png"
plt.savefig(fig_path + name_fig, dpi=300)
plt.close()
