...
#sec_len = [120, 120, 65, 139]

WWed = '/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM10extend_shflim_S_sec_WWed_5days_annual.nc'
print(WWed)
...
WRos = '/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM10extend_shflim_S_sec_WRos_5days_annual.nc'
print(WRos)
...
EWed = '/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM10extend_shflim_S_sec_EWed_5days_annual.nc'
print(EWed)
...
ERos = '/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM10extend_shflim_S_sec_ERos_5days_annual.nc'
print(ERos)
...
name_fig="waom10extend_shflim_S_0.25Q_RF-RISsections_TSdiag_depth_yr20.png"
...
name_fig="waom10extend_shflim_S_0.25Q_RF-RISsections_TSdiag+sections_yr20.png"
plt.savefig(fig_path + name_fig, dpi=300)
