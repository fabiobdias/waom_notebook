...
ds = xr.open_dataset("/scratch/gh9/fbd581/ROMS/waom10shrink_shflim_S_0.25Q_ORAS5em/output_01-20yr/ocean_avg_0020.nc")
...
dg = xr.open_dataset("/g/data3/hh5/tmp/access-om/fbd581/ROMS/waom10_frc/waom10shrink_grd.nc")
...
ds[variables].isel(ocean_time=slice(0, 12), #wed
                  xi_rho=170, eta_rho=slice(310,480)).to_netcdf(ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_wed_ann_yr20.nc', mode='w')

ds[variables].isel(ocean_time=slice(0, 12), # ros
                  xi_rho=310, eta_rho=slice(50,280)).to_netcdf(ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_ros_ann_yr20.nc', mode='w')

ds[variables].isel(ocean_time=slice(0, 12), # pry
                  xi_rho=slice(420,600), eta_rho=368).to_netcdf(ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_pry_ann_yr20.nc', mode='w')

ds[variables].isel(ocean_time=slice(0, 12), # neu
                  xi_rho=280, eta_rho=slice(450,550)).to_netcdf(ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_neu_ann_yr20.nc', mode='w')

ds[variables].isel(ocean_time=slice(0, 12), # mai
                  xi_rho=320, eta_rho=slice(450,550)).to_netcdf(ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_mai_ann_yr20.nc', mode='w')

ds[variables].isel(ocean_time=slice(0, 12), # dar
                  eta_rho=380, xi_rho=slice(460,615)).to_netcdf(ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_dar_ann_yr20.nc', mode='w')

ds[variables].isel(ocean_time=slice(0, 12), # mer
                  xi_rho=435, eta_rho=slice(40,110)).to_netcdf(ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_mer_ann_yr20.nc', mode='w')

ds[variables].isel(ocean_time=slice(0, 12), # amu
                  eta_rho=225, xi_rho=slice(50,200)).to_netcdf(ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_amu_ann_yr20.nc', mode='w')

print('saved')

# load vars for TS plot
wed=ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_wed_ann_yr20.nc'
...
ros=ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_ros_ann_yr20.nc'
...
pry=ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_pry_ann_yr20.nc'
...
neu=ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_neu_ann_yr20.nc'
...
mai=ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_mai_ann_yr20.nc'
...
mer=ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_mer_ann_yr20.nc'
...
dar=ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_dar_ann_yr20.nc'
...
amu=ncdftmp_path + 'WAOM10extend_shflim_S_0.25Q_ORAS5emsec_amu_ann_yr20.nc'
...
name_fig="waom10shrink_shflim_S_0.25Q_ORAS5em_AllDSWsections_TSdiag_depth_yr20.png"
...
name_fig="waom10shrink_shflim_S_0.25Q_ORAS5em_DSW+sections_TSdiag_depth_yr20.png"
plt.savefig(fig_path + name_fig, dpi=300)
