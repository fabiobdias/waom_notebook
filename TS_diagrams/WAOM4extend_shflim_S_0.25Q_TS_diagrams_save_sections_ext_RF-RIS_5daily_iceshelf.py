...
# extend xi_point laterraly (following WMT TS-space analysis):
        ds[variables].isel(ocean_time=slice(0, 8),xi_rho=slice(xi_pt[ind_ij]-12,xi_pt[ind_ij]+12),eta_rho=slice(eta_sec_ini[ind_ij],eta_sec_end[ind_ij])).to_netcdf('/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM4extend_shflim_S_sec_ext_'+ sec_name + '_5days_mm' + mm + '_iceshelf.nc', mode='w', format='NETCDF4')
