...
ds[variables].isel(ocean_time=slice(0, 12), #wed
                  xi_rho=170, eta_rho=slice(280,450)).to_netcdf(ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_wed_ann_yr20.nc', mode='w')

ds[variables].isel(ocean_time=slice(0, 12), # ros
                  xi_rho=310, eta_rho=slice(20,250)).to_netcdf(ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_ros_ann_yr20.nc', mode='w')

ds[variables].isel(ocean_time=slice(0, 12), # pry
                  xi_rho=slice(420,600), eta_rho=338).to_netcdf(ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_pry_ann_yr20.nc', mode='w')

ds[variables].isel(ocean_time=slice(0, 12), # neu
                  xi_rho=280, eta_rho=slice(420,520)).to_netcdf(ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_neu_ann_yr20.nc', mode='w')

ds[variables].isel(ocean_time=slice(0, 12), # mai
                  xi_rho=320, eta_rho=slice(420,520)).to_netcdf(ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_mai_ann_yr20.nc', mode='w')

ds[variables].isel(ocean_time=slice(0, 12), # dar
                  eta_rho=350, xi_rho=slice(460,615)).to_netcdf(ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_dar_ann_yr20.nc', mode='w')

ds[variables].isel(ocean_time=slice(0, 12), # mer
                  xi_rho=435, eta_rho=slice(10,80)).to_netcdf(ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_mer_ann_yr20.nc', mode='w')

ds[variables].isel(ocean_time=slice(0, 12), # amu
                  eta_rho=195, xi_rho=slice(50,200)).to_netcdf(ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_amu_ann_yr20.nc', mode='w')

print('saved')

# load vars for TS plot
wed=ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_wed_ann_yr20.nc'
...
ros=ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_ros_ann_yr20.nc'
...
pry=ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_pry_ann_yr20.nc'
...
neu=ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_neu_ann_yr20.nc'
...
mai=ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_mai_ann_yr20.nc'
...
mer=ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_mer_ann_yr20.nc'
...
dar=ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_dar_ann_yr20.nc'
...
amu=ncdftmp_path + 'WAOM_shflim_S_ORAS5_0.25Q_sec_amu_ann_yr20.nc'
...
name_fig="waom10_shflim_S_ORAS5em_0.25Q_AllDSWsections_TSdiag_depth_yr20.png"
...
name_fig="waom10_shflim_S_ORAS5_0.25Q_DSW+sections_TSdiag_depth_yr20.png"
plt.savefig(fig_path + name_fig, dpi=300)
