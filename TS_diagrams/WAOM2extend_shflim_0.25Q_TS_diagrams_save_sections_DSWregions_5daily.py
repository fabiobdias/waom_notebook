...
xi_pt = [950, 1550, 1400, 1600, 2176]
eta_sec_ini = [1550, 250, 2250, 2250, 200]
eta_sec_end = [2400, 1400, 2750, 2750, 550]
# index for xi var sections (dar, pry, amu)
xi_sec_ini = [2300, 2100, 250]
xi_sec_end = [3076, 3000, 1000]
eta_pt = [1900, 1840, 1126]
# length of the section (wed, ros, neu, mai, mer, dar, pry, amu)
sec_len = [850, 1150, 500, 500, 350, 776, 900, 750]
