...
dfw = xr.open_dataset("/g/data3/hh5/tmp/access-om/fbd581/ROMS/waom4_frc/waom4extend_swflux.nc")

dshf = xr.open_dataset("/g/data3/hh5/tmp/access-om/fbd581/ROMS/waom4_frc/waom4extend_shflux_0.25Q.nc")

dens=gsw.rho(salt,temp,0)-1000

di = xr.open_dataset("/g/data3/hh5/tmp/access-om/fbd581/NSIDC/seaice_conc_monthly_sh_f13_200701_v03r01.nc")
...
count=0
for mm in ['01','02','03','04','05','06','07','08','09','10','11','12']:
    di_tmp = xr.open_dataset("/g/data3/hh5/tmp/access-om/fbd581/NSIDC/seaice_conc_monthly_sh_f13_2007" + mm + "_v03r01.nc")
...
plt.savefig('/g/data3/hh5/tmp/access-om/fbd581/ROMS/postprocessing/figs/WAOM4extend_notides_temp-salt+transects_RF-RIS.png', dpi=300)
plt.close()
...
plt.savefig('/g/data3/hh5/tmp/access-om/fbd581/ROMS/postprocessing/figs/WAOM4extend_notides_currents+transects_RF-RIS.png', dpi=300)
plt.close()
...
plt.savefig('/g/data3/hh5/tmp/access-om/fbd581/ROMS/postprocessing/figs/WAOM4extend_notides_currents+transects_RFIS.png', dpi=300)
plt.close()
...
plt.savefig('/g/data3/hh5/tmp/access-om/fbd581/ROMS/postprocessing/figs/WAOM4extend_notides_currents+transects_RIS.png', dpi=300)
plt.close()
...
plt.savefig('/g/data3/hh5/tmp/access-om/fbd581/ROMS/postprocessing/figs/WAOM4extend_notides_bottom_velTS+transects_RFIS.png', dpi=300)
plt.close()
...
plt.savefig('/g/data3/hh5/tmp/access-om/fbd581/ROMS/postprocessing/figs/WAOM4extend_notides_bottom_velTS+transects_RIS.png', dpi=300)
plt.close()
...
plt.savefig('/g/data3/hh5/tmp/access-om/fbd581/ROMS/postprocessing/figs/WAOM4extend_notides_NSIDC_September_sea-ice+transects_RF-RIS.png', dpi=300)
...
fig_path='/g/data3/hh5/tmp/access-om/fbd581/ROMS/postprocessing/figs/Cross_sections/'
...
name_fig="waom4extend_notideswedW_section_seas_yr20.png"
...
name_fig="waom4extend_notideswedE_section_seas_yr20.png"
plt.savefig(fig_path + name_fig)
...
name_fig="waom4extend_notidesrosW_section_seas_yr20.png"
plt.savefig(fig_path + name_fig)
...
name_fig="waom4extend_notidesrosE_section_seas_yr20.png"
plt.savefig(fig_path + name_fig)
...
name_fig="waom4extend_notidesRF-RISsections_annual_yr20.png"
plt.savefig(fig_path + name_fig)
