...
xi_pt = [425, 775, 700, 800, 1088]
eta_sec_ini = [700, 50, 1050, 1050, 25]
eta_sec_end = [1125, 625, 1300, 1300, 200]
# index for xi var sections (dar, pry, amu)
xi_sec_ini = [1150, 1050, 125]
xi_sec_end = [1538, 1500, 500]
eta_pt = [875, 845, 488]
# length of the section (wed, ros, neu, mai, mer, dar, pry, amu)
sec_len = [425, 575, 250, 250, 175, 388, 450, 375]
...
# load ROMS avg output
    ...
    for mm in ['01','02','03','04','05','06','07','08','09','10','11','12']:
        ...
        if sec_name == 'wed' or sec_name ==  'ros' or sec_name ==  'neu' or sec_name ==  'mai' or sec_name ==  'mer':
            ...
            ds[variables].isel(ocean_time=slice(0, 8),xi_rho=xi_pt[ind_ij], eta_rho=slice(eta_sec_ini[ind_ij],eta_sec_end[ind_ij])).to_netcdf('/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM4_shflim_S_sec_'+ sec_name + '_5days_mm' + mm + '.nc', mode='w', format='NETCDF4')
        elif sec_name == 'pry' or sec_name ==  'dar' or sec_name ==  'amu':
            print(sec_name, 'eta =', eta_pt[ind_ij], 'xi =', xi_sec_ini[ind_ij], xi_sec_end[ind_ij])
            ds[variables].isel(ocean_time=slice(0, 8),xi_rho=slice(xi_sec_ini[ind_ij],xi_sec_end[ind_ij]), eta_rho=eta_pt[ind_ij]).to_netcdf('/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM4_shflim_S_sec_'+ sec_name + '_5days_mm' + mm + '.nc', mode='w', format='NETCDF4')
