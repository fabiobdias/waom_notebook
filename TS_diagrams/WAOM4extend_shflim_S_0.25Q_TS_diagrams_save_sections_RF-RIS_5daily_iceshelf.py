...
# load ROMS avg output
    ...
    for mm in ['01','02','03','04','05','06','07','08','09','10','11','12']:
        ...
        ds[variables].isel(ocean_time=slice(0, 8),xi_rho=xi_pt[ind_ij], eta_rho=slice(eta_sec_ini[ind_ij],eta_sec_end[ind_ij])).to_netcdf('/users/boeiradi/COLD_project/postprocessing/ncdf_tmp/WAOM4extend_shflim_S_sec_'+ sec_name + '_5days_mm' + mm + '_iceshelf.nc', mode='w', format='NETCDF4')
