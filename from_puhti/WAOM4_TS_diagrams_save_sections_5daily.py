...
# saving all variables including temp/salt
            ds[variables].isel(ocean_time=slice(0, 8),xi_rho=slice(xi_sec_ini[ind_ij],xi_sec_end[ind_ij]), eta_rho=eta_pt[ind_ij]).to_netcdf('/scratch/project_2000339/boeiradi/postprocessing/ncdf_tmp/WAOM4_sec_' + sec_name + '_5days_mm' + mm + '.nc', mode='w', format='NETCDF4')
