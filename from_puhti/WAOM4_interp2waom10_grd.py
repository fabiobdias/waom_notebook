...
data_dir = os.path.join('/scratch','project_2000339','boeiradi','waom4_shflim_S_mahti','output_10yr')
...
def interp_roms_4to10km(): # 'wed',0,0
    ...
    for mm in ['01','02','03','04','05','06','07','08','09','10','11','12']:
        hr_ds = xr.open_dataset("/scratch/project_2000339/boeiradi/waom4_shflim_S_mahti/output_10yr/ocean_avg_00" + mm + ".nc")
...
lr_avg =  xr.open_dataset("/scratch/project_2000339/boeiradi/waom10_shflim_S/output_11-15yr/ocean_avg_0003.nc")
