...
# load ROMS avg output
    ...
    for mm in ['01','02','03','04','05','06','07','08','09','10','11','12']:
        ds = xr.open_dataset("/scratch/project_2000339/boeiradi/waom4_shflim_S_mahti/output_3yr/ocean_avg_00" + mm + ".nc")
...
#plt.tight_layout()
plt.savefig('figs/WAOM4/waom4_shflim_S_all_sections_temp_annual_new.png')
plt.close(fig)
...
#plt.tight_layout()
plt.savefig('figs/WAOM4/waom4_shflim_S_all_sections_salt_annual_new.png')
plt.close(fig)
...
#plt.tight_layout()
plt.savefig('figs/WAOM4/waom4_shflim_S_all_sections_rho_annual_new.png', dpi=300)
plt.close(fig)
...
plt.savefig('figs/WAOM4/waom4_shflim_S_DSW_sections_rho_annual_new.png')
plt.close(fig)
