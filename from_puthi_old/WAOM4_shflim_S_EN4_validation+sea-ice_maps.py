...
plt.savefig('figs/WAOM4/waom4_shflim_SxEN4_surface_TS__annual.png')
plt.close() 
...
plt.savefig('figs/WAOM4/waom4_shflim_SxEN4_bottom_TS_annual.png')
plt.close()
...
plt.savefig('figs/WAOM4/waom4_shflim_S_bottom_TS_annual.png')
plt.close()
